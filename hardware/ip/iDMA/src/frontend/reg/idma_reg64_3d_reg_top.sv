...
module idma_reg64_3d_reg_top #(
  ...
  // To HW
  output idma_reg64_3d_reg_pkg::idma_reg64_3d_reg2hw_t reg2hw, // Write
  input  idma_reg64_3d_reg_pkg::idma_reg64_3d_hw2reg_t hw2reg, // Read
  ...
  logic [31:0] dst_stride_3_high_qs;
  logic [31:0] dst_stride_3_high_wd;
  logic dst_stride_3_high_we;
  logic [31:0] src_stride_3_low_qs;
  logic [31:0] src_stride_3_low_wd;
  logic src_stride_3_low_we;
  logic [31:0] src_stride_3_high_qs;
  logic [31:0] src_stride_3_high_wd;
  logic src_stride_3_high_we;
  logic [31:0] reps_3_low_qs;
  logic [31:0] reps_3_low_wd;
  logic reps_3_low_we;
  logic [31:0] reps_3_high_qs;
  logic [31:0] reps_3_high_wd;
  logic reps_3_high_we;
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (dst_stride_3_high_we),
    .wd     (dst_stride_3_high_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.dst_stride_3_high.q ),

    // to register interface (read)
    .qs     (dst_stride_3_high_qs)
  );
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (src_stride_3_high_we),
    .wd     (src_stride_3_high_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.src_stride_3_high.q ),

    // to register interface (read)
    .qs     (src_stride_3_high_qs)
  );
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == IDMA_REG64_3D_CONF_OFFSET);
    addr_hit[ 1] = (reg_addr == IDMA_REG64_3D_STATUS_0_OFFSET);
    addr_hit[ 2] = (reg_addr == IDMA_REG64_3D_STATUS_1_OFFSET);
    addr_hit[ 3] = (reg_addr == IDMA_REG64_3D_STATUS_2_OFFSET);
    addr_hit[ 4] = (reg_addr == IDMA_REG64_3D_STATUS_3_OFFSET);
    addr_hit[ 5] = (reg_addr == IDMA_REG64_3D_STATUS_4_OFFSET);
    addr_hit[ 6] = (reg_addr == IDMA_REG64_3D_STATUS_5_OFFSET);
    addr_hit[ 7] = (reg_addr == IDMA_REG64_3D_STATUS_6_OFFSET);
    addr_hit[ 8] = (reg_addr == IDMA_REG64_3D_STATUS_7_OFFSET);
    addr_hit[ 9] = (reg_addr == IDMA_REG64_3D_STATUS_8_OFFSET);
    addr_hit[10] = (reg_addr == IDMA_REG64_3D_STATUS_9_OFFSET);
    addr_hit[11] = (reg_addr == IDMA_REG64_3D_STATUS_10_OFFSET);
    addr_hit[12] = (reg_addr == IDMA_REG64_3D_STATUS_11_OFFSET);
    addr_hit[13] = (reg_addr == IDMA_REG64_3D_STATUS_12_OFFSET);
    addr_hit[14] = (reg_addr == IDMA_REG64_3D_STATUS_13_OFFSET);
    addr_hit[15] = (reg_addr == IDMA_REG64_3D_STATUS_14_OFFSET);
    addr_hit[16] = (reg_addr == IDMA_REG64_3D_STATUS_15_OFFSET);
    addr_hit[17] = (reg_addr == IDMA_REG64_3D_NEXT_ID_0_OFFSET);
    addr_hit[18] = (reg_addr == IDMA_REG64_3D_NEXT_ID_1_OFFSET);
    addr_hit[19] = (reg_addr == IDMA_REG64_3D_NEXT_ID_2_OFFSET);
    addr_hit[20] = (reg_addr == IDMA_REG64_3D_NEXT_ID_3_OFFSET);
    addr_hit[21] = (reg_addr == IDMA_REG64_3D_NEXT_ID_4_OFFSET);
    addr_hit[22] = (reg_addr == IDMA_REG64_3D_NEXT_ID_5_OFFSET);
    addr_hit[23] = (reg_addr == IDMA_REG64_3D_NEXT_ID_6_OFFSET);
    addr_hit[24] = (reg_addr == IDMA_REG64_3D_NEXT_ID_7_OFFSET);
    addr_hit[25] = (reg_addr == IDMA_REG64_3D_NEXT_ID_8_OFFSET);
    addr_hit[26] = (reg_addr == IDMA_REG64_3D_NEXT_ID_9_OFFSET);
    addr_hit[27] = (reg_addr == IDMA_REG64_3D_NEXT_ID_10_OFFSET);
    addr_hit[28] = (reg_addr == IDMA_REG64_3D_NEXT_ID_11_OFFSET);
    addr_hit[29] = (reg_addr == IDMA_REG64_3D_NEXT_ID_12_OFFSET);
    addr_hit[30] = (reg_addr == IDMA_REG64_3D_NEXT_ID_13_OFFSET);
    addr_hit[31] = (reg_addr == IDMA_REG64_3D_NEXT_ID_14_OFFSET);
    addr_hit[32] = (reg_addr == IDMA_REG64_3D_NEXT_ID_15_OFFSET);
    addr_hit[33] = (reg_addr == IDMA_REG64_3D_DONE_ID_0_OFFSET);
    addr_hit[34] = (reg_addr == IDMA_REG64_3D_DONE_ID_1_OFFSET);
    addr_hit[35] = (reg_addr == IDMA_REG64_3D_DONE_ID_2_OFFSET);
    addr_hit[36] = (reg_addr == IDMA_REG64_3D_DONE_ID_3_OFFSET);
    addr_hit[37] = (reg_addr == IDMA_REG64_3D_DONE_ID_4_OFFSET);
    addr_hit[38] = (reg_addr == IDMA_REG64_3D_DONE_ID_5_OFFSET);
    addr_hit[39] = (reg_addr == IDMA_REG64_3D_DONE_ID_6_OFFSET);
    addr_hit[40] = (reg_addr == IDMA_REG64_3D_DONE_ID_7_OFFSET);
    addr_hit[41] = (reg_addr == IDMA_REG64_3D_DONE_ID_8_OFFSET);
    addr_hit[42] = (reg_addr == IDMA_REG64_3D_DONE_ID_9_OFFSET);
    addr_hit[43] = (reg_addr == IDMA_REG64_3D_DONE_ID_10_OFFSET);
    addr_hit[44] = (reg_addr == IDMA_REG64_3D_DONE_ID_11_OFFSET);
    addr_hit[45] = (reg_addr == IDMA_REG64_3D_DONE_ID_12_OFFSET);
    addr_hit[46] = (reg_addr == IDMA_REG64_3D_DONE_ID_13_OFFSET);
    addr_hit[47] = (reg_addr == IDMA_REG64_3D_DONE_ID_14_OFFSET);
    addr_hit[48] = (reg_addr == IDMA_REG64_3D_DONE_ID_15_OFFSET);
    addr_hit[49] = (reg_addr == IDMA_REG64_3D_DST_ADDR_LOW_OFFSET);
    addr_hit[50] = (reg_addr == IDMA_REG64_3D_DST_ADDR_HIGH_OFFSET);
    addr_hit[51] = (reg_addr == IDMA_REG64_3D_SRC_ADDR_LOW_OFFSET);
    addr_hit[52] = (reg_addr == IDMA_REG64_3D_SRC_ADDR_HIGH_OFFSET);
    addr_hit[53] = (reg_addr == IDMA_REG64_3D_LENGTH_LOW_OFFSET);
    addr_hit[54] = (reg_addr == IDMA_REG64_3D_LENGTH_HIGH_OFFSET);
    addr_hit[55] = (reg_addr == IDMA_REG64_3D_DST_STRIDE_2_LOW_OFFSET);
    addr_hit[56] = (reg_addr == IDMA_REG64_3D_DST_STRIDE_2_HIGH_OFFSET);
    addr_hit[57] = (reg_addr == IDMA_REG64_3D_SRC_STRIDE_2_LOW_OFFSET);
    addr_hit[58] = (reg_addr == IDMA_REG64_3D_SRC_STRIDE_2_HIGH_OFFSET);
    addr_hit[59] = (reg_addr == IDMA_REG64_3D_REPS_2_LOW_OFFSET);
    addr_hit[60] = (reg_addr == IDMA_REG64_3D_REPS_2_HIGH_OFFSET);
    addr_hit[61] = (reg_addr == IDMA_REG64_3D_DST_STRIDE_3_LOW_OFFSET);
    addr_hit[62] = (reg_addr == IDMA_REG64_3D_DST_STRIDE_3_HIGH_OFFSET);
    addr_hit[63] = (reg_addr == IDMA_REG64_3D_SRC_STRIDE_3_LOW_OFFSET);
    addr_hit[64] = (reg_addr == IDMA_REG64_3D_SRC_STRIDE_3_HIGH_OFFSET);
    addr_hit[65] = (reg_addr == IDMA_REG64_3D_REPS_3_LOW_OFFSET);
    addr_hit[66] = (reg_addr == IDMA_REG64_3D_REPS_3_HIGH_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(IDMA_REG64_3D_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(IDMA_REG64_3D_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(IDMA_REG64_3D_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(IDMA_REG64_3D_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(IDMA_REG64_3D_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(IDMA_REG64_3D_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(IDMA_REG64_3D_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(IDMA_REG64_3D_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(IDMA_REG64_3D_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(IDMA_REG64_3D_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(IDMA_REG64_3D_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(IDMA_REG64_3D_PERMIT[11] & ~reg_be))) |
               (addr_hit[12] & (|(IDMA_REG64_3D_PERMIT[12] & ~reg_be))) |
               (addr_hit[13] & (|(IDMA_REG64_3D_PERMIT[13] & ~reg_be))) |
               (addr_hit[14] & (|(IDMA_REG64_3D_PERMIT[14] & ~reg_be))) |
               (addr_hit[15] & (|(IDMA_REG64_3D_PERMIT[15] & ~reg_be))) |
               (addr_hit[16] & (|(IDMA_REG64_3D_PERMIT[16] & ~reg_be))) |
               (addr_hit[17] & (|(IDMA_REG64_3D_PERMIT[17] & ~reg_be))) |
               (addr_hit[18] & (|(IDMA_REG64_3D_PERMIT[18] & ~reg_be))) |
               (addr_hit[19] & (|(IDMA_REG64_3D_PERMIT[19] & ~reg_be))) |
               (addr_hit[20] & (|(IDMA_REG64_3D_PERMIT[20] & ~reg_be))) |
               (addr_hit[21] & (|(IDMA_REG64_3D_PERMIT[21] & ~reg_be))) |
               (addr_hit[22] & (|(IDMA_REG64_3D_PERMIT[22] & ~reg_be))) |
               (addr_hit[23] & (|(IDMA_REG64_3D_PERMIT[23] & ~reg_be))) |
               (addr_hit[24] & (|(IDMA_REG64_3D_PERMIT[24] & ~reg_be))) |
               (addr_hit[25] & (|(IDMA_REG64_3D_PERMIT[25] & ~reg_be))) |
               (addr_hit[26] & (|(IDMA_REG64_3D_PERMIT[26] & ~reg_be))) |
               (addr_hit[27] & (|(IDMA_REG64_3D_PERMIT[27] & ~reg_be))) |
               (addr_hit[28] & (|(IDMA_REG64_3D_PERMIT[28] & ~reg_be))) |
               (addr_hit[29] & (|(IDMA_REG64_3D_PERMIT[29] & ~reg_be))) |
               (addr_hit[30] & (|(IDMA_REG64_3D_PERMIT[30] & ~reg_be))) |
               (addr_hit[31] & (|(IDMA_REG64_3D_PERMIT[31] & ~reg_be))) |
               (addr_hit[32] & (|(IDMA_REG64_3D_PERMIT[32] & ~reg_be))) |
               (addr_hit[33] & (|(IDMA_REG64_3D_PERMIT[33] & ~reg_be))) |
               (addr_hit[34] & (|(IDMA_REG64_3D_PERMIT[34] & ~reg_be))) |
               (addr_hit[35] & (|(IDMA_REG64_3D_PERMIT[35] & ~reg_be))) |
               (addr_hit[36] & (|(IDMA_REG64_3D_PERMIT[36] & ~reg_be))) |
               (addr_hit[37] & (|(IDMA_REG64_3D_PERMIT[37] & ~reg_be))) |
               (addr_hit[38] & (|(IDMA_REG64_3D_PERMIT[38] & ~reg_be))) |
               (addr_hit[39] & (|(IDMA_REG64_3D_PERMIT[39] & ~reg_be))) |
               (addr_hit[40] & (|(IDMA_REG64_3D_PERMIT[40] & ~reg_be))) |
               (addr_hit[41] & (|(IDMA_REG64_3D_PERMIT[41] & ~reg_be))) |
               (addr_hit[42] & (|(IDMA_REG64_3D_PERMIT[42] & ~reg_be))) |
               (addr_hit[43] & (|(IDMA_REG64_3D_PERMIT[43] & ~reg_be))) |
               (addr_hit[44] & (|(IDMA_REG64_3D_PERMIT[44] & ~reg_be))) |
               (addr_hit[45] & (|(IDMA_REG64_3D_PERMIT[45] & ~reg_be))) |
               (addr_hit[46] & (|(IDMA_REG64_3D_PERMIT[46] & ~reg_be))) |
               (addr_hit[47] & (|(IDMA_REG64_3D_PERMIT[47] & ~reg_be))) |
               (addr_hit[48] & (|(IDMA_REG64_3D_PERMIT[48] & ~reg_be))) |
               (addr_hit[49] & (|(IDMA_REG64_3D_PERMIT[49] & ~reg_be))) |
               (addr_hit[50] & (|(IDMA_REG64_3D_PERMIT[50] & ~reg_be))) |
               (addr_hit[51] & (|(IDMA_REG64_3D_PERMIT[51] & ~reg_be))) |
               (addr_hit[52] & (|(IDMA_REG64_3D_PERMIT[52] & ~reg_be))) |
               (addr_hit[53] & (|(IDMA_REG64_3D_PERMIT[53] & ~reg_be))) |
               (addr_hit[54] & (|(IDMA_REG64_3D_PERMIT[54] & ~reg_be))) |
               (addr_hit[55] & (|(IDMA_REG64_3D_PERMIT[55] & ~reg_be))) |
               (addr_hit[56] & (|(IDMA_REG64_3D_PERMIT[56] & ~reg_be))) |
               (addr_hit[57] & (|(IDMA_REG64_3D_PERMIT[57] & ~reg_be))) |
               (addr_hit[58] & (|(IDMA_REG64_3D_PERMIT[58] & ~reg_be))) |
               (addr_hit[59] & (|(IDMA_REG64_3D_PERMIT[59] & ~reg_be))) |
               (addr_hit[60] & (|(IDMA_REG64_3D_PERMIT[60] & ~reg_be))) |
               (addr_hit[61] & (|(IDMA_REG64_3D_PERMIT[61] & ~reg_be))) |
               (addr_hit[62] & (|(IDMA_REG64_3D_PERMIT[62] & ~reg_be))) |
               (addr_hit[63] & (|(IDMA_REG64_3D_PERMIT[63] & ~reg_be))) |
               (addr_hit[64] & (|(IDMA_REG64_3D_PERMIT[64] & ~reg_be))) |
               (addr_hit[65] & (|(IDMA_REG64_3D_PERMIT[65] & ~reg_be))) |
               (addr_hit[66] & (|(IDMA_REG64_3D_PERMIT[66] & ~reg_be)))));
  end
  ...
  assign dst_stride_3_low_we = addr_hit[61] & reg_we & !reg_error;
  assign dst_stride_3_low_wd = reg_wdata[31:0];

  assign dst_stride_3_high_we = addr_hit[62] & reg_we & !reg_error;
  assign dst_stride_3_high_wd = reg_wdata[31:0];

  assign src_stride_3_low_we = addr_hit[63] & reg_we & !reg_error;
  assign src_stride_3_low_wd = reg_wdata[31:0];

  assign src_stride_3_high_we = addr_hit[64] & reg_we & !reg_error;
  assign src_stride_3_high_wd = reg_wdata[31:0];

  assign reps_3_low_we = addr_hit[65] & reg_we & !reg_error;
  assign reps_3_low_wd = reg_wdata[31:0];

  assign reps_3_high_we = addr_hit[66] & reg_we & !reg_error;
  assign reps_3_high_wd = reg_wdata[31:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[62]: begin
        reg_rdata_next[31:0] = dst_stride_3_high_qs;
      end
      ...
      addr_hit[64]: begin
        reg_rdata_next[31:0] = src_stride_3_high_qs;
      end
      ...
      addr_hit[66]: begin
        reg_rdata_next[31:0] = reps_3_high_qs;
      end
...
module idma_reg64_3d_reg_top_intf
#(
  parameter int AW = 9,
  localparam int DW = 32
) (
