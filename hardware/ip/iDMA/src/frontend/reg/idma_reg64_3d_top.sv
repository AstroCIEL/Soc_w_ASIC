...
module idma_reg64_3d #(
  ...
  idma_reg64_3d_reg_pkg::idma_reg64_3d_reg2hw_t [NumRegs-1:0] dma_reg2hw;
  idma_reg64_3d_reg_pkg::idma_reg64_3d_hw2reg_t [NumRegs-1:0] dma_hw2reg;
  ...
  for (genvar i = 0; i < NumRegs; i++) begin : gen_core_regs
    ...
    idma_reg64_3d_reg_top #(
      .reg_req_t ( reg_req_t ),
      .reg_rsp_t ( reg_rsp_t )
    ) i_idma_reg64_3d_reg_top (
      .clk_i,
      .rst_ni,
    ...
    always_comb begin : proc_hw_req_conv
      ...
      arb_dma_req[i].d_req[1].reps = {dma_reg2hw[i].reps_3_high.q,
                                      dma_reg2hw[i].reps_3_low.q };
      arb_dma_req[i].d_req[1].src_strides = {dma_reg2hw[i].src_stride_3_high.q,
                                             dma_reg2hw[i].src_stride_3_low.q};
      arb_dma_req[i].d_req[1].dst_strides = {dma_reg2hw[i].dst_stride_3_high.q,
                                             dma_reg2hw[i].dst_stride_3_low.q};
