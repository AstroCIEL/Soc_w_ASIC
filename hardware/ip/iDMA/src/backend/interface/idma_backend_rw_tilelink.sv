...
module idma_backend_rw_tilelink #(
    /// Data width
    ...
    //--------------------------------------
    idma_transport_layer_rw_tilelink #(
        ...
        .rst_ni          ( rst_ni               ),
        .testmode_i      ( testmode_i           ),
        .tilelink_read_req_o  ( tilelink_read_req_o       ),
        .tilelink_read_rsp_i  ( tilelink_read_rsp_i       ),
        .tilelink_write_req_o ( tilelink_write_req_o      ),
        .tilelink_write_rsp_i ( tilelink_write_rsp_i      ),
