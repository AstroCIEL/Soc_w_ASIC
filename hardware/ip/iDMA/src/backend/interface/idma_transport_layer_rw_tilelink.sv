...
module idma_transport_layer_rw_tilelink #(
    ...
    /// TileLink-UH Request and Response channel type
    ...
    idma_tilelink_read #(
        ...
        .read_req_t       ( tilelink_req_t           ),
        .read_rsp_t       ( tilelink_rsp_t           )
        ...
        .read_req_o        ( tilelink_read_req_o ),
        .read_rsp_i        ( tilelink_read_rsp_i ),
    ...
    idma_tilelink_write #(
        ...
        .write_req_t       ( tilelink_req_t       ),
        .write_rsp_t       ( tilelink_rsp_t       )
        ...
        .write_req_o        ( tilelink_write_req_o ),
        .write_rsp_i        ( tilelink_write_rsp_i ),
