...
//       
//       Creation Date:  Sun May 10 21:21:32 2026
//       Version: 	r1p0
//
...
module datapath_latch_sram_4096_64 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_sram_4096_64
...
`ifdef POWER_PINS
module sram_4096_64 (VDDCE, VDDPE, VSSE, q, clk, cen, gwen, a, d, stov, ema, emaw, 
    emas, ret1n);
`else
module sram_4096_64 (q, clk, cen, gwen, a, d, stov, ema, emaw, emas, ret1n);
`endif
...
`endif
   ...
   `ifdef ARM_FAULT_MODELING
     sram_4096_64_error_injection u1(.CLK(clk_), .Q_out(q_out), .A(a_int), .CEN(cen_int), .GWEN(gwen_int), .WEN(gwen_int), .Q_in(q_int));
  `else
   assign q_out = q_int;
  `endif
...
`endif
  ...
  datapath_latch_sram_4096_64 uDQ0 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(1'b0), .D(d_int_bmux[0]), .DFTRAMBYP(1'b0), .mem_path(mem_path[0]), .XQ(Xq|Xd_int[0]|1'b0), .Q(q_int[0]));
  datapath_latch_sram_4096_64 uDQ1 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[0]), .D(d_int_bmux[1]), .DFTRAMBYP(1'b0), .mem_path(mem_path[1]), .XQ(Xq|Xd_int[1]), .Q(q_int[1]));
  datapath_latch_sram_4096_64 uDQ2 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[1]), .D(d_int_bmux[2]), .DFTRAMBYP(1'b0), .mem_path(mem_path[2]), .XQ(Xq|Xd_int[2]), .Q(q_int[2]));
  datapath_latch_sram_4096_64 uDQ3 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[2]), .D(d_int_bmux[3]), .DFTRAMBYP(1'b0), .mem_path(mem_path[3]), .XQ(Xq|Xd_int[3]), .Q(q_int[3]));
  datapath_latch_sram_4096_64 uDQ4 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[3]), .D(d_int_bmux[4]), .DFTRAMBYP(1'b0), .mem_path(mem_path[4]), .XQ(Xq|Xd_int[4]), .Q(q_int[4]));
  datapath_latch_sram_4096_64 uDQ5 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[4]), .D(d_int_bmux[5]), .DFTRAMBYP(1'b0), .mem_path(mem_path[5]), .XQ(Xq|Xd_int[5]), .Q(q_int[5]));
  datapath_latch_sram_4096_64 uDQ6 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[5]), .D(d_int_bmux[6]), .DFTRAMBYP(1'b0), .mem_path(mem_path[6]), .XQ(Xq|Xd_int[6]), .Q(q_int[6]));
  datapath_latch_sram_4096_64 uDQ7 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[6]), .D(d_int_bmux[7]), .DFTRAMBYP(1'b0), .mem_path(mem_path[7]), .XQ(Xq|Xd_int[7]), .Q(q_int[7]));
  datapath_latch_sram_4096_64 uDQ8 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[7]), .D(d_int_bmux[8]), .DFTRAMBYP(1'b0), .mem_path(mem_path[8]), .XQ(Xq|Xd_int[8]), .Q(q_int[8]));
  datapath_latch_sram_4096_64 uDQ9 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[8]), .D(d_int_bmux[9]), .DFTRAMBYP(1'b0), .mem_path(mem_path[9]), .XQ(Xq|Xd_int[9]), .Q(q_int[9]));
  datapath_latch_sram_4096_64 uDQ10 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[9]), .D(d_int_bmux[10]), .DFTRAMBYP(1'b0), .mem_path(mem_path[10]), .XQ(Xq|Xd_int[10]), .Q(q_int[10]));
  datapath_latch_sram_4096_64 uDQ11 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[10]), .D(d_int_bmux[11]), .DFTRAMBYP(1'b0), .mem_path(mem_path[11]), .XQ(Xq|Xd_int[11]), .Q(q_int[11]));
  datapath_latch_sram_4096_64 uDQ12 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[11]), .D(d_int_bmux[12]), .DFTRAMBYP(1'b0), .mem_path(mem_path[12]), .XQ(Xq|Xd_int[12]), .Q(q_int[12]));
  datapath_latch_sram_4096_64 uDQ13 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[12]), .D(d_int_bmux[13]), .DFTRAMBYP(1'b0), .mem_path(mem_path[13]), .XQ(Xq|Xd_int[13]), .Q(q_int[13]));
  datapath_latch_sram_4096_64 uDQ14 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[13]), .D(d_int_bmux[14]), .DFTRAMBYP(1'b0), .mem_path(mem_path[14]), .XQ(Xq|Xd_int[14]), .Q(q_int[14]));
  datapath_latch_sram_4096_64 uDQ15 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[14]), .D(d_int_bmux[15]), .DFTRAMBYP(1'b0), .mem_path(mem_path[15]), .XQ(Xq|Xd_int[15]), .Q(q_int[15]));
  datapath_latch_sram_4096_64 uDQ16 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[15]), .D(d_int_bmux[16]), .DFTRAMBYP(1'b0), .mem_path(mem_path[16]), .XQ(Xq|Xd_int[16]), .Q(q_int[16]));
  datapath_latch_sram_4096_64 uDQ17 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[16]), .D(d_int_bmux[17]), .DFTRAMBYP(1'b0), .mem_path(mem_path[17]), .XQ(Xq|Xd_int[17]), .Q(q_int[17]));
  datapath_latch_sram_4096_64 uDQ18 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[17]), .D(d_int_bmux[18]), .DFTRAMBYP(1'b0), .mem_path(mem_path[18]), .XQ(Xq|Xd_int[18]), .Q(q_int[18]));
  datapath_latch_sram_4096_64 uDQ19 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[18]), .D(d_int_bmux[19]), .DFTRAMBYP(1'b0), .mem_path(mem_path[19]), .XQ(Xq|Xd_int[19]), .Q(q_int[19]));
  datapath_latch_sram_4096_64 uDQ20 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[19]), .D(d_int_bmux[20]), .DFTRAMBYP(1'b0), .mem_path(mem_path[20]), .XQ(Xq|Xd_int[20]), .Q(q_int[20]));
  datapath_latch_sram_4096_64 uDQ21 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[20]), .D(d_int_bmux[21]), .DFTRAMBYP(1'b0), .mem_path(mem_path[21]), .XQ(Xq|Xd_int[21]), .Q(q_int[21]));
  datapath_latch_sram_4096_64 uDQ22 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[21]), .D(d_int_bmux[22]), .DFTRAMBYP(1'b0), .mem_path(mem_path[22]), .XQ(Xq|Xd_int[22]), .Q(q_int[22]));
  datapath_latch_sram_4096_64 uDQ23 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[22]), .D(d_int_bmux[23]), .DFTRAMBYP(1'b0), .mem_path(mem_path[23]), .XQ(Xq|Xd_int[23]), .Q(q_int[23]));
  datapath_latch_sram_4096_64 uDQ24 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[23]), .D(d_int_bmux[24]), .DFTRAMBYP(1'b0), .mem_path(mem_path[24]), .XQ(Xq|Xd_int[24]), .Q(q_int[24]));
  datapath_latch_sram_4096_64 uDQ25 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[24]), .D(d_int_bmux[25]), .DFTRAMBYP(1'b0), .mem_path(mem_path[25]), .XQ(Xq|Xd_int[25]), .Q(q_int[25]));
  datapath_latch_sram_4096_64 uDQ26 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[25]), .D(d_int_bmux[26]), .DFTRAMBYP(1'b0), .mem_path(mem_path[26]), .XQ(Xq|Xd_int[26]), .Q(q_int[26]));
  datapath_latch_sram_4096_64 uDQ27 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[26]), .D(d_int_bmux[27]), .DFTRAMBYP(1'b0), .mem_path(mem_path[27]), .XQ(Xq|Xd_int[27]), .Q(q_int[27]));
  datapath_latch_sram_4096_64 uDQ28 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[27]), .D(d_int_bmux[28]), .DFTRAMBYP(1'b0), .mem_path(mem_path[28]), .XQ(Xq|Xd_int[28]), .Q(q_int[28]));
  datapath_latch_sram_4096_64 uDQ29 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[28]), .D(d_int_bmux[29]), .DFTRAMBYP(1'b0), .mem_path(mem_path[29]), .XQ(Xq|Xd_int[29]), .Q(q_int[29]));
  datapath_latch_sram_4096_64 uDQ30 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[29]), .D(d_int_bmux[30]), .DFTRAMBYP(1'b0), .mem_path(mem_path[30]), .XQ(Xq|Xd_int[30]), .Q(q_int[30]));
  datapath_latch_sram_4096_64 uDQ31 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[30]), .D(d_int_bmux[31]), .DFTRAMBYP(1'b0), .mem_path(mem_path[31]), .XQ(Xq|Xd_int[31]), .Q(q_int[31]));
  datapath_latch_sram_4096_64 uDQ32 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[33]), .D(d_int_bmux[32]), .DFTRAMBYP(1'b0), .mem_path(mem_path[32]), .XQ(Xq|Xd_int[32]), .Q(q_int[32]));
  datapath_latch_sram_4096_64 uDQ33 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[34]), .D(d_int_bmux[33]), .DFTRAMBYP(1'b0), .mem_path(mem_path[33]), .XQ(Xq|Xd_int[33]), .Q(q_int[33]));
  datapath_latch_sram_4096_64 uDQ34 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[35]), .D(d_int_bmux[34]), .DFTRAMBYP(1'b0), .mem_path(mem_path[34]), .XQ(Xq|Xd_int[34]), .Q(q_int[34]));
  datapath_latch_sram_4096_64 uDQ35 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[36]), .D(d_int_bmux[35]), .DFTRAMBYP(1'b0), .mem_path(mem_path[35]), .XQ(Xq|Xd_int[35]), .Q(q_int[35]));
  datapath_latch_sram_4096_64 uDQ36 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[37]), .D(d_int_bmux[36]), .DFTRAMBYP(1'b0), .mem_path(mem_path[36]), .XQ(Xq|Xd_int[36]), .Q(q_int[36]));
  datapath_latch_sram_4096_64 uDQ37 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[38]), .D(d_int_bmux[37]), .DFTRAMBYP(1'b0), .mem_path(mem_path[37]), .XQ(Xq|Xd_int[37]), .Q(q_int[37]));
  datapath_latch_sram_4096_64 uDQ38 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[39]), .D(d_int_bmux[38]), .DFTRAMBYP(1'b0), .mem_path(mem_path[38]), .XQ(Xq|Xd_int[38]), .Q(q_int[38]));
  datapath_latch_sram_4096_64 uDQ39 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[40]), .D(d_int_bmux[39]), .DFTRAMBYP(1'b0), .mem_path(mem_path[39]), .XQ(Xq|Xd_int[39]), .Q(q_int[39]));
  datapath_latch_sram_4096_64 uDQ40 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[41]), .D(d_int_bmux[40]), .DFTRAMBYP(1'b0), .mem_path(mem_path[40]), .XQ(Xq|Xd_int[40]), .Q(q_int[40]));
  datapath_latch_sram_4096_64 uDQ41 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[42]), .D(d_int_bmux[41]), .DFTRAMBYP(1'b0), .mem_path(mem_path[41]), .XQ(Xq|Xd_int[41]), .Q(q_int[41]));
  datapath_latch_sram_4096_64 uDQ42 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[43]), .D(d_int_bmux[42]), .DFTRAMBYP(1'b0), .mem_path(mem_path[42]), .XQ(Xq|Xd_int[42]), .Q(q_int[42]));
  datapath_latch_sram_4096_64 uDQ43 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[44]), .D(d_int_bmux[43]), .DFTRAMBYP(1'b0), .mem_path(mem_path[43]), .XQ(Xq|Xd_int[43]), .Q(q_int[43]));
  datapath_latch_sram_4096_64 uDQ44 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[45]), .D(d_int_bmux[44]), .DFTRAMBYP(1'b0), .mem_path(mem_path[44]), .XQ(Xq|Xd_int[44]), .Q(q_int[44]));
  datapath_latch_sram_4096_64 uDQ45 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[46]), .D(d_int_bmux[45]), .DFTRAMBYP(1'b0), .mem_path(mem_path[45]), .XQ(Xq|Xd_int[45]), .Q(q_int[45]));
  datapath_latch_sram_4096_64 uDQ46 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[47]), .D(d_int_bmux[46]), .DFTRAMBYP(1'b0), .mem_path(mem_path[46]), .XQ(Xq|Xd_int[46]), .Q(q_int[46]));
  datapath_latch_sram_4096_64 uDQ47 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[48]), .D(d_int_bmux[47]), .DFTRAMBYP(1'b0), .mem_path(mem_path[47]), .XQ(Xq|Xd_int[47]), .Q(q_int[47]));
  datapath_latch_sram_4096_64 uDQ48 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[49]), .D(d_int_bmux[48]), .DFTRAMBYP(1'b0), .mem_path(mem_path[48]), .XQ(Xq|Xd_int[48]), .Q(q_int[48]));
  datapath_latch_sram_4096_64 uDQ49 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[50]), .D(d_int_bmux[49]), .DFTRAMBYP(1'b0), .mem_path(mem_path[49]), .XQ(Xq|Xd_int[49]), .Q(q_int[49]));
  datapath_latch_sram_4096_64 uDQ50 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[51]), .D(d_int_bmux[50]), .DFTRAMBYP(1'b0), .mem_path(mem_path[50]), .XQ(Xq|Xd_int[50]), .Q(q_int[50]));
  datapath_latch_sram_4096_64 uDQ51 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[52]), .D(d_int_bmux[51]), .DFTRAMBYP(1'b0), .mem_path(mem_path[51]), .XQ(Xq|Xd_int[51]), .Q(q_int[51]));
  datapath_latch_sram_4096_64 uDQ52 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[53]), .D(d_int_bmux[52]), .DFTRAMBYP(1'b0), .mem_path(mem_path[52]), .XQ(Xq|Xd_int[52]), .Q(q_int[52]));
  datapath_latch_sram_4096_64 uDQ53 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[54]), .D(d_int_bmux[53]), .DFTRAMBYP(1'b0), .mem_path(mem_path[53]), .XQ(Xq|Xd_int[53]), .Q(q_int[53]));
  datapath_latch_sram_4096_64 uDQ54 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[55]), .D(d_int_bmux[54]), .DFTRAMBYP(1'b0), .mem_path(mem_path[54]), .XQ(Xq|Xd_int[54]), .Q(q_int[54]));
  datapath_latch_sram_4096_64 uDQ55 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[56]), .D(d_int_bmux[55]), .DFTRAMBYP(1'b0), .mem_path(mem_path[55]), .XQ(Xq|Xd_int[55]), .Q(q_int[55]));
  datapath_latch_sram_4096_64 uDQ56 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[57]), .D(d_int_bmux[56]), .DFTRAMBYP(1'b0), .mem_path(mem_path[56]), .XQ(Xq|Xd_int[56]), .Q(q_int[56]));
  datapath_latch_sram_4096_64 uDQ57 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[58]), .D(d_int_bmux[57]), .DFTRAMBYP(1'b0), .mem_path(mem_path[57]), .XQ(Xq|Xd_int[57]), .Q(q_int[57]));
  datapath_latch_sram_4096_64 uDQ58 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[59]), .D(d_int_bmux[58]), .DFTRAMBYP(1'b0), .mem_path(mem_path[58]), .XQ(Xq|Xd_int[58]), .Q(q_int[58]));
  datapath_latch_sram_4096_64 uDQ59 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[60]), .D(d_int_bmux[59]), .DFTRAMBYP(1'b0), .mem_path(mem_path[59]), .XQ(Xq|Xd_int[59]), .Q(q_int[59]));
  datapath_latch_sram_4096_64 uDQ60 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[61]), .D(d_int_bmux[60]), .DFTRAMBYP(1'b0), .mem_path(mem_path[60]), .XQ(Xq|Xd_int[60]), .Q(q_int[60]));
  datapath_latch_sram_4096_64 uDQ61 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[62]), .D(d_int_bmux[61]), .DFTRAMBYP(1'b0), .mem_path(mem_path[61]), .XQ(Xq|Xd_int[61]), .Q(q_int[61]));
  datapath_latch_sram_4096_64 uDQ62 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[63]), .D(d_int_bmux[62]), .DFTRAMBYP(1'b0), .mem_path(mem_path[62]), .XQ(Xq|Xd_int[62]), .Q(q_int[62]));
  datapath_latch_sram_4096_64 uDQ63 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(1'b0), .D(d_int_bmux[63]), .DFTRAMBYP(1'b0), .mem_path(mem_path[63]), .XQ(Xq|Xd_int[63]|1'b0), .Q(q_int[63]));
...
`ifdef ARM_FAULT_MODELING
`timescale 1ns/1ps
module sram_4096_64_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [63:0] Q_out;
   input [63:0] Q_in;
   input CLK;
   input [11:0] A;
...
initial
begin
   `ifdef sram_4096_64_pre_pend_path
      `define pre_pend_path `sram_4096_64_pre_pend_path
   `else
      `ifdef DUT
