//////////////////////////////////////////////////////////////////////////////////
// global_buffer: 4 × sram_4096_64 (4096×64b SP SRAM) in one address space.
//
...
//
//   sram_4096_64 has no per-bit write mask; axi_byte_en_i is accepted for
...
module global_buffer #(
    ...
    // Register bank select on read (aligns with sram_4096_64 read latency).
    ...
    // -------------------------------------------------------------------------
    // sram_4096_64 instances (active-low cen; gwen 0=write 1=read)
    // -------------------------------------------------------------------------
    genvar i;
    generate
