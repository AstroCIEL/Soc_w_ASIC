...
//       
//       Creation Date:  Sat Jun 13 04:29:13 2026
//       Version: 	r0p0
//
...
`else
module rf128x128 (q, clk, cen, wen, a, d, ema, emaw, emas, gwen, ret1n, wabl, wablm,
    rawl, rawlm);
`endif
...
`endif
 ...
 wire  clk_;
  ...
  buf B401(wabl_, wabl);
  buf B402(wablm_[0], wablm[0]);
  buf B403(wablm_[1], wablm[1]);
  buf B404(rawl_, rawl);
  buf B405(rawlm_[0], rawlm[0]);
  buf B406(rawlm_[1], rawlm[1]);
