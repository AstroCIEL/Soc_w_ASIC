...
module mergeArrayController(
	...
	assign up_ready = (mode==`MODE_UINT4 || mode==`MODE_INT4)? dn_ready: w_up_ready;
	assign dn_valid = (mode==`MODE_UINT4 || mode==`MODE_INT4)? up_valid: w_dn_valid;
	assign cnt_zero = (w_cnt==0);
