...
//
// Description: Minimum SoC top + custom ASIC with internal DMA (separate RTL tree from `minimum/`).
...
module ariane_soc_top import axi_pkg::*; #(
  ...
  assign addr_map = '{
    ...
    '{ idx: ariane_soc::ASIC,     start_addr: ariane_soc::ASICBase,     end_addr: ariane_soc::ASICBase + ariane_soc::ASICLength         },
  ...
  ariane_peripherals #(
    ...
    .asic_cfg       ( master[ariane_soc::ASIC]     ),
    .asic_mst       ( slave [ariane_soc::AsicDmaMst] ),
    .irq_o          ( irqs                         ),
    .exit_o         ( ctrl_exit                    ),
