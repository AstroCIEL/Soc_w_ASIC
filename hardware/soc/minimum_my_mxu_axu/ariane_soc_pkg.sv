...
package ariane_soc;
  ...
  typedef enum int unsigned {
    ...
    //MXU的四个接口
    MxuCfg     =9, //配置寄存器
    MxuWgtBuf  =10, //weight buffer sram接口
    MxuActBuf  =11, //activation buffer sram接口
    MxuOutBuf  =12, //output buffer sram接口

    //AXU的四个接口
    AxuCfg     =13, //配置寄存器
    AxuOpABuf  =14, //op_a buffer sram接口
  ...
  localparam logic[63:0] MxuActBufLength   = 64'h8000; // 256*128*8/8=32KB
  localparam logic[63:0] MxuOutBufLength   = 64'h8000; // 256*128*8/8=32KB

  localparam logic[63:0] AxuCfgLength      = 64'h1000; // 4KB
