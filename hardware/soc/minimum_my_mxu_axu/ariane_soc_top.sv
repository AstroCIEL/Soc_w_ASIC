...
// Intermediate AXI bus for dm_top master output (before register cut)
  ...
  assign addr_map = '{
    ...
    '{ idx: ariane_soc::MxuCfg,    start_addr: ariane_soc::MxuCfgBase,    end_addr: ariane_soc::MxuCfgBase    + ariane_soc::MxuCfgLength },
    '{ idx: ariane_soc::MxuWgtBuf, start_addr: ariane_soc::MxuWgtBufBase, end_addr: ariane_soc::MxuWgtBufBase + ariane_soc::MxuWgtBufLength },
    '{ idx: ariane_soc::MxuActBuf, start_addr: ariane_soc::MxuActBufBase, end_addr: ariane_soc::MxuActBufBase + ariane_soc::MxuActBufLength },
    '{ idx: ariane_soc::MxuOutBuf, start_addr: ariane_soc::MxuOutBufBase, end_addr: ariane_soc::MxuOutBufBase + ariane_soc::MxuOutBufLength },
  ...
  ariane_peripherals #(
    ...
    .mxu_cfg        (master[ariane_soc::MxuCfg]    ),
    .mxu_wgt        (master[ariane_soc::MxuWgtBuf]    ),
    .mxu_act        (master[ariane_soc::MxuActBuf]    ),
    .mxu_out        (master[ariane_soc::MxuOutBuf]    ),

    .axu_cfg        (master[ariane_soc::AxuCfg]    ),
