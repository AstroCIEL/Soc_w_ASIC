...
//
// Description: Minimum SoC top + VMMA (VecMatMul + internal DMA), fourth variant (`minimum_vmma_dma/`).
...
module ariane_soc_top import axi_pkg::*; #(
  ...
  assign addr_map = '{
    ...
    '{ idx: ariane_soc::VMMA,     start_addr: ariane_soc::VMMABase,     end_addr: ariane_soc::VMMABase + ariane_soc::VMMALength         },
  ...
  ariane_peripherals #(
    ...
    .vmma_cfg       ( master[ariane_soc::VMMA]     ),
    .vmma_mst       ( slave [ariane_soc::VmmaDmaMst] ),
    .irq_o          ( irqs                         ),
    .exit_o         ( ctrl_exit                    ),
