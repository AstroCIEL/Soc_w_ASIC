...
//
//       Instance Name:              rf_icache_64x128
//       Words:                      64
//       Bits:                       128
//       Mux:                        2
//       Drive:                      6
...
//       
//       Creation Date:  Sat May  9 08:42:41 2026
//       Version: 	r3p1
//
...
`ifdef POWER_PINS
module rf_icache_64x128 (VDDCE, VDDPE, VSSE, q, clk, cen, wen, a, d, ema, emaw, emas, 
    gwen, ret1n, wabl, wablm, rawl, rawlm);
`else
module rf_icache_64x128 (q, clk, cen, wen, a, d, ema, emaw, emas, gwen, ret1n, wabl, 
    wablm, rawl, rawlm);
`endif
 ...
 wire  clk_;
  ...
  assign rawlm_[1] = rawlm[1];
   ...
   `ifdef ARM_FAULT_MODELING
     rf_icache_64x128_error_injection u1(.CLK(clk_), .Q_out(q_out), .A(a_int), .CEN(cen_int), .GWEN(gwen_int), .WEN(wen_int), .Q_in(q_int));
   `else
     assign q_out = q_int;
   `endif
...
`timescale 1ns/1ps
`ifdef ARM_FAULT_MODELING
module rf_icache_64x128_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [127:0] Q_out;
   input [127:0] Q_in;
   input CLK;
   input [5:0] A;
...
initial
begin
   `ifdef rf_icache_64x128_pre_pend_path
      `define pre_pend_path `rf_icache_64x128_pre_pend_path
   `else
      `ifdef DUT
