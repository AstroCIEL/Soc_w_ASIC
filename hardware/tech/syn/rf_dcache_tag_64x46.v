...
//
//       Instance Name:              rf_dcache_tag_64x46
//       Words:                      64
//       Bits:                       46
//       Mux:                        2
//       Drive:                      6
...
//       
//       Creation Date:  Sat May  9 08:48:26 2026
//       Version: 	r3p1
//
...
`ifdef POWER_PINS
module rf_dcache_tag_64x46 (VDDCE, VDDPE, VSSE, q, clk, cen, wen, a, d, ema, emaw, 
    emas, gwen, ret1n, wabl, wablm, rawl, rawlm);
`else
module rf_dcache_tag_64x46 (q, clk, cen, wen, a, d, ema, emaw, emas, gwen, ret1n, wabl, 
    wablm, rawl, rawlm);
`endif
 ...
 wire  clk_;
  ...
  assign rawlm_[1] = rawlm[1];
   ...
   `ifdef ARM_FAULT_MODELING
     rf_dcache_tag_64x46_error_injection u1(.CLK(clk_), .Q_out(q_out), .A(a_int), .CEN(cen_int), .GWEN(gwen_int), .WEN(wen_int), .Q_in(q_int));
   `else
     assign q_out = q_int;
   `endif
...
`endif
  ...
  begin
    ...
    if (ret1n_int === 1'bx || ret1n_int === 1'bz) begin
      ...
      q_int = gwen_int !== 1'b1 ? q_int : {46{1'bx}};
     ...
     if (gwen_int !== 1)
      ...
      if( isBitX(gwen_int) ) begin
        ...
        d_int = {46{1'bx}};
          ...
          writeEnable = ~ ( {46{gwen_int}} | {wen_int[45], wen_int[44], wen_int[43],
...
`endif
  ...
  reg NOT_cen, NOT_wen45, NOT_wen44, NOT_wen43, NOT_wen42, NOT_wen41, NOT_wen40, NOT_wen39;
  reg NOT_wen38, NOT_wen37, NOT_wen36, NOT_wen35, NOT_wen34, NOT_wen33, NOT_wen32;
  reg NOT_wen31, NOT_wen30, NOT_wen29, NOT_wen28, NOT_wen27, NOT_wen26, NOT_wen25;
  ...
  reg NOT_wen2, NOT_wen1, NOT_wen0, NOT_a5, NOT_a4, NOT_a3, NOT_a2, NOT_a1, NOT_a0;
  reg NOT_d45, NOT_d44, NOT_d43, NOT_d42, NOT_d41, NOT_d40, NOT_d39, NOT_d38, NOT_d37;
  reg NOT_d36, NOT_d35, NOT_d34, NOT_d33, NOT_d32, NOT_d31, NOT_d30, NOT_d29, NOT_d28;
  ...
  reg NOT_ema2, NOT_ema1, NOT_ema0, NOT_emaw1, NOT_emaw0, NOT_emas, NOT_gwen, NOT_ret1n;
  reg NOT_wabl, NOT_wablm1, NOT_wablm0, NOT_rawl, NOT_rawlm1, NOT_rawlm0;
 ...
 wire  clk_;
  ...
  buf B46(clk_, clk);
  buf B47(cen_, cen);
  buf B48(wen_[0], wen[0]);
  buf B49(wen_[1], wen[1]);
  buf B50(wen_[2], wen[2]);
  buf B51(wen_[3], wen[3]);
  buf B52(wen_[4], wen[4]);
  buf B53(wen_[5], wen[5]);
  buf B54(wen_[6], wen[6]);
  buf B55(wen_[7], wen[7]);
  buf B56(wen_[8], wen[8]);
  buf B57(wen_[9], wen[9]);
  buf B58(wen_[10], wen[10]);
  buf B59(wen_[11], wen[11]);
  buf B60(wen_[12], wen[12]);
  buf B61(wen_[13], wen[13]);
  buf B62(wen_[14], wen[14]);
  buf B63(wen_[15], wen[15]);
  buf B64(wen_[16], wen[16]);
  buf B65(wen_[17], wen[17]);
  buf B66(wen_[18], wen[18]);
  buf B67(wen_[19], wen[19]);
  buf B68(wen_[20], wen[20]);
  buf B69(wen_[21], wen[21]);
  buf B70(wen_[22], wen[22]);
  buf B71(wen_[23], wen[23]);
  buf B72(wen_[24], wen[24]);
  buf B73(wen_[25], wen[25]);
  buf B74(wen_[26], wen[26]);
  buf B75(wen_[27], wen[27]);
  buf B76(wen_[28], wen[28]);
  buf B77(wen_[29], wen[29]);
  buf B78(wen_[30], wen[30]);
  buf B79(wen_[31], wen[31]);
  buf B80(wen_[32], wen[32]);
  buf B81(wen_[33], wen[33]);
  buf B82(wen_[34], wen[34]);
  buf B83(wen_[35], wen[35]);
  buf B84(wen_[36], wen[36]);
  buf B85(wen_[37], wen[37]);
  buf B86(wen_[38], wen[38]);
  buf B87(wen_[39], wen[39]);
  buf B88(wen_[40], wen[40]);
  buf B89(wen_[41], wen[41]);
  buf B90(wen_[42], wen[42]);
  buf B91(wen_[43], wen[43]);
  buf B92(wen_[44], wen[44]);
  buf B93(wen_[45], wen[45]);
  buf B94(a_[0], a[0]);
  buf B95(a_[1], a[1]);
  buf B96(a_[2], a[2]);
  buf B97(a_[3], a[3]);
  ...
  buf B144(d_[44], d[44]);
  buf B145(d_[45], d[45]);
  buf B146(ema_[0], ema[0]);
  buf B147(ema_[1], ema[1]);
  buf B148(ema_[2], ema[2]);
  buf B149(emaw_[0], emaw[0]);
  buf B150(emaw_[1], emaw[1]);
  buf B151(emas_, emas);
  buf B152(gwen_, gwen);
  buf B153(ret1n_, ret1n);
  buf B154(wabl_, wabl);
  buf B155(wablm_[0], wablm[0]);
  buf B156(wablm_[1], wablm[1]);
  buf B157(rawl_, rawl);
  buf B158(rawlm_[0], rawlm[0]);
  buf B159(rawlm_[1], rawlm[1]);
...
`endif
  ...
  wire rawleq1awableq0aret1neq1aceneq0, rawleq0awableq0aret1neq1aceneq0, ret1neq1aceneq0awen45eq0agweneq0;
...
`timescale 1ns/1ps
`ifdef ARM_FAULT_MODELING
module rf_dcache_tag_64x46_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [45:0] Q_out;
   input [45:0] Q_in;
   input CLK;
   input [5:0] A;
...
initial
begin
   `ifdef rf_dcache_tag_64x46_pre_pend_path
      `define pre_pend_path `rf_dcache_tag_64x46_pre_pend_path
   `else
      `ifdef DUT
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.u1.add_fault(6'd1,6'd0,2'd1,2'd0);
   `endif
end
   task add_fault;
