...
//       
//       Creation Date:  Fri Jan 31 07:41:38 2025
//       Version: 	r6p0
//
...
`define ARM_OFFSET_TIME 0
  ...
  `define SRAM_SP_HDE_SHVT_MVT_ARM_REF_EMA_VALUE   7
  `define SRAM_SP_HDE_SHVT_MVT_ARM_REF_EMAW_VALUE  3
  `define SRAM_SP_HDE_SHVT_MVT_ARM_REF_EMAS_VALUE  1


module datapath_latch_sram1024x64 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_sram1024x64
...
`ifdef POWER_PINS
module sram1024x64 (VDDCE, VDDPE, VSSE, Q, CLK, CEN, GWEN, A, D, WEN, STOV, EMA, EMAW, 
    EMAS, RET1N, RAWL, RAWLM, WABL, WABLM);
`else
module sram1024x64 (Q, CLK, CEN, GWEN, A, D, WEN, STOV, EMA, EMAW, EMAS, RET1N, RAWL, 
    RAWLM, WABL, WABLM);
`endif
...
`endif
   ...
   `ifdef ARM_FAULT_MODELING
     sram1024x64_error_injection u1(.CLK(CLK_), .Q_out(Q_out), .A(A_int), .CEN(CEN_int), .GWEN(GWEN_int), .WEN(WEN_int), .Q_in(Q_int));
  `else
   assign Q_out = Q_int;
  `endif
...
`endif
	  ...
	  mux_address = (Atemp & 2'b11);
       ...
       row = mem[row_address];
        ...
        new_data =  ( {3'b000, wordtemp[63], 3'b000, wordtemp[62], 3'b000, wordtemp[61],
...
`endif
  ...
  datapath_latch_sram1024x64 uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(1'b0), .D(D_int_bmux[0]), .DFTRAMBYP(1'b0), .mem_path(mem_path[0]), .XQ(XQ|XD_int[0]|1'b0), .Q(Q_int[0]));
  datapath_latch_sram1024x64 uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(1'b0), .mem_path(mem_path[1]), .XQ(XQ|XD_int[1]), .Q(Q_int[1]));
  datapath_latch_sram1024x64 uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(1'b0), .mem_path(mem_path[2]), .XQ(XQ|XD_int[2]), .Q(Q_int[2]));
  datapath_latch_sram1024x64 uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(1'b0), .mem_path(mem_path[3]), .XQ(XQ|XD_int[3]), .Q(Q_int[3]));
  datapath_latch_sram1024x64 uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(1'b0), .mem_path(mem_path[4]), .XQ(XQ|XD_int[4]), .Q(Q_int[4]));
  datapath_latch_sram1024x64 uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(1'b0), .mem_path(mem_path[5]), .XQ(XQ|XD_int[5]), .Q(Q_int[5]));
  datapath_latch_sram1024x64 uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(1'b0), .mem_path(mem_path[6]), .XQ(XQ|XD_int[6]), .Q(Q_int[6]));
  datapath_latch_sram1024x64 uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(1'b0), .mem_path(mem_path[7]), .XQ(XQ|XD_int[7]), .Q(Q_int[7]));
  datapath_latch_sram1024x64 uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(1'b0), .mem_path(mem_path[8]), .XQ(XQ|XD_int[8]), .Q(Q_int[8]));
  datapath_latch_sram1024x64 uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(1'b0), .mem_path(mem_path[9]), .XQ(XQ|XD_int[9]), .Q(Q_int[9]));
  datapath_latch_sram1024x64 uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(1'b0), .mem_path(mem_path[10]), .XQ(XQ|XD_int[10]), .Q(Q_int[10]));
  datapath_latch_sram1024x64 uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(1'b0), .mem_path(mem_path[11]), .XQ(XQ|XD_int[11]), .Q(Q_int[11]));
  datapath_latch_sram1024x64 uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(1'b0), .mem_path(mem_path[12]), .XQ(XQ|XD_int[12]), .Q(Q_int[12]));
  datapath_latch_sram1024x64 uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(1'b0), .mem_path(mem_path[13]), .XQ(XQ|XD_int[13]), .Q(Q_int[13]));
  datapath_latch_sram1024x64 uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(1'b0), .mem_path(mem_path[14]), .XQ(XQ|XD_int[14]), .Q(Q_int[14]));
  datapath_latch_sram1024x64 uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(1'b0), .mem_path(mem_path[15]), .XQ(XQ|XD_int[15]), .Q(Q_int[15]));
  datapath_latch_sram1024x64 uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[15]), .D(D_int_bmux[16]), .DFTRAMBYP(1'b0), .mem_path(mem_path[16]), .XQ(XQ|XD_int[16]), .Q(Q_int[16]));
  datapath_latch_sram1024x64 uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[16]), .D(D_int_bmux[17]), .DFTRAMBYP(1'b0), .mem_path(mem_path[17]), .XQ(XQ|XD_int[17]), .Q(Q_int[17]));
  datapath_latch_sram1024x64 uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[17]), .D(D_int_bmux[18]), .DFTRAMBYP(1'b0), .mem_path(mem_path[18]), .XQ(XQ|XD_int[18]), .Q(Q_int[18]));
  datapath_latch_sram1024x64 uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[18]), .D(D_int_bmux[19]), .DFTRAMBYP(1'b0), .mem_path(mem_path[19]), .XQ(XQ|XD_int[19]), .Q(Q_int[19]));
  datapath_latch_sram1024x64 uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[19]), .D(D_int_bmux[20]), .DFTRAMBYP(1'b0), .mem_path(mem_path[20]), .XQ(XQ|XD_int[20]), .Q(Q_int[20]));
  datapath_latch_sram1024x64 uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[20]), .D(D_int_bmux[21]), .DFTRAMBYP(1'b0), .mem_path(mem_path[21]), .XQ(XQ|XD_int[21]), .Q(Q_int[21]));
  datapath_latch_sram1024x64 uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[21]), .D(D_int_bmux[22]), .DFTRAMBYP(1'b0), .mem_path(mem_path[22]), .XQ(XQ|XD_int[22]), .Q(Q_int[22]));
  datapath_latch_sram1024x64 uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[22]), .D(D_int_bmux[23]), .DFTRAMBYP(1'b0), .mem_path(mem_path[23]), .XQ(XQ|XD_int[23]), .Q(Q_int[23]));
  datapath_latch_sram1024x64 uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[23]), .D(D_int_bmux[24]), .DFTRAMBYP(1'b0), .mem_path(mem_path[24]), .XQ(XQ|XD_int[24]), .Q(Q_int[24]));
  datapath_latch_sram1024x64 uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[24]), .D(D_int_bmux[25]), .DFTRAMBYP(1'b0), .mem_path(mem_path[25]), .XQ(XQ|XD_int[25]), .Q(Q_int[25]));
  datapath_latch_sram1024x64 uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[25]), .D(D_int_bmux[26]), .DFTRAMBYP(1'b0), .mem_path(mem_path[26]), .XQ(XQ|XD_int[26]), .Q(Q_int[26]));
  datapath_latch_sram1024x64 uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[26]), .D(D_int_bmux[27]), .DFTRAMBYP(1'b0), .mem_path(mem_path[27]), .XQ(XQ|XD_int[27]), .Q(Q_int[27]));
  datapath_latch_sram1024x64 uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[27]), .D(D_int_bmux[28]), .DFTRAMBYP(1'b0), .mem_path(mem_path[28]), .XQ(XQ|XD_int[28]), .Q(Q_int[28]));
  datapath_latch_sram1024x64 uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[28]), .D(D_int_bmux[29]), .DFTRAMBYP(1'b0), .mem_path(mem_path[29]), .XQ(XQ|XD_int[29]), .Q(Q_int[29]));
  datapath_latch_sram1024x64 uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[29]), .D(D_int_bmux[30]), .DFTRAMBYP(1'b0), .mem_path(mem_path[30]), .XQ(XQ|XD_int[30]), .Q(Q_int[30]));
  datapath_latch_sram1024x64 uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[30]), .D(D_int_bmux[31]), .DFTRAMBYP(1'b0), .mem_path(mem_path[31]), .XQ(XQ|XD_int[31]), .Q(Q_int[31]));
  datapath_latch_sram1024x64 uDQ32 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[33]), .D(D_int_bmux[32]), .DFTRAMBYP(1'b0), .mem_path(mem_path[32]), .XQ(XQ|XD_int[32]), .Q(Q_int[32]));
  datapath_latch_sram1024x64 uDQ33 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[34]), .D(D_int_bmux[33]), .DFTRAMBYP(1'b0), .mem_path(mem_path[33]), .XQ(XQ|XD_int[33]), .Q(Q_int[33]));
  datapath_latch_sram1024x64 uDQ34 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[35]), .D(D_int_bmux[34]), .DFTRAMBYP(1'b0), .mem_path(mem_path[34]), .XQ(XQ|XD_int[34]), .Q(Q_int[34]));
  datapath_latch_sram1024x64 uDQ35 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[36]), .D(D_int_bmux[35]), .DFTRAMBYP(1'b0), .mem_path(mem_path[35]), .XQ(XQ|XD_int[35]), .Q(Q_int[35]));
  datapath_latch_sram1024x64 uDQ36 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[37]), .D(D_int_bmux[36]), .DFTRAMBYP(1'b0), .mem_path(mem_path[36]), .XQ(XQ|XD_int[36]), .Q(Q_int[36]));
  datapath_latch_sram1024x64 uDQ37 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[38]), .D(D_int_bmux[37]), .DFTRAMBYP(1'b0), .mem_path(mem_path[37]), .XQ(XQ|XD_int[37]), .Q(Q_int[37]));
  datapath_latch_sram1024x64 uDQ38 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[39]), .D(D_int_bmux[38]), .DFTRAMBYP(1'b0), .mem_path(mem_path[38]), .XQ(XQ|XD_int[38]), .Q(Q_int[38]));
  datapath_latch_sram1024x64 uDQ39 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[40]), .D(D_int_bmux[39]), .DFTRAMBYP(1'b0), .mem_path(mem_path[39]), .XQ(XQ|XD_int[39]), .Q(Q_int[39]));
  datapath_latch_sram1024x64 uDQ40 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[41]), .D(D_int_bmux[40]), .DFTRAMBYP(1'b0), .mem_path(mem_path[40]), .XQ(XQ|XD_int[40]), .Q(Q_int[40]));
  datapath_latch_sram1024x64 uDQ41 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[42]), .D(D_int_bmux[41]), .DFTRAMBYP(1'b0), .mem_path(mem_path[41]), .XQ(XQ|XD_int[41]), .Q(Q_int[41]));
  datapath_latch_sram1024x64 uDQ42 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[43]), .D(D_int_bmux[42]), .DFTRAMBYP(1'b0), .mem_path(mem_path[42]), .XQ(XQ|XD_int[42]), .Q(Q_int[42]));
  datapath_latch_sram1024x64 uDQ43 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[44]), .D(D_int_bmux[43]), .DFTRAMBYP(1'b0), .mem_path(mem_path[43]), .XQ(XQ|XD_int[43]), .Q(Q_int[43]));
  datapath_latch_sram1024x64 uDQ44 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[45]), .D(D_int_bmux[44]), .DFTRAMBYP(1'b0), .mem_path(mem_path[44]), .XQ(XQ|XD_int[44]), .Q(Q_int[44]));
  datapath_latch_sram1024x64 uDQ45 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[46]), .D(D_int_bmux[45]), .DFTRAMBYP(1'b0), .mem_path(mem_path[45]), .XQ(XQ|XD_int[45]), .Q(Q_int[45]));
  datapath_latch_sram1024x64 uDQ46 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[47]), .D(D_int_bmux[46]), .DFTRAMBYP(1'b0), .mem_path(mem_path[46]), .XQ(XQ|XD_int[46]), .Q(Q_int[46]));
  datapath_latch_sram1024x64 uDQ47 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[48]), .D(D_int_bmux[47]), .DFTRAMBYP(1'b0), .mem_path(mem_path[47]), .XQ(XQ|XD_int[47]), .Q(Q_int[47]));
  datapath_latch_sram1024x64 uDQ48 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[49]), .D(D_int_bmux[48]), .DFTRAMBYP(1'b0), .mem_path(mem_path[48]), .XQ(XQ|XD_int[48]), .Q(Q_int[48]));
  datapath_latch_sram1024x64 uDQ49 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[50]), .D(D_int_bmux[49]), .DFTRAMBYP(1'b0), .mem_path(mem_path[49]), .XQ(XQ|XD_int[49]), .Q(Q_int[49]));
  datapath_latch_sram1024x64 uDQ50 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[51]), .D(D_int_bmux[50]), .DFTRAMBYP(1'b0), .mem_path(mem_path[50]), .XQ(XQ|XD_int[50]), .Q(Q_int[50]));
  datapath_latch_sram1024x64 uDQ51 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[52]), .D(D_int_bmux[51]), .DFTRAMBYP(1'b0), .mem_path(mem_path[51]), .XQ(XQ|XD_int[51]), .Q(Q_int[51]));
  datapath_latch_sram1024x64 uDQ52 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[53]), .D(D_int_bmux[52]), .DFTRAMBYP(1'b0), .mem_path(mem_path[52]), .XQ(XQ|XD_int[52]), .Q(Q_int[52]));
  datapath_latch_sram1024x64 uDQ53 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[54]), .D(D_int_bmux[53]), .DFTRAMBYP(1'b0), .mem_path(mem_path[53]), .XQ(XQ|XD_int[53]), .Q(Q_int[53]));
  datapath_latch_sram1024x64 uDQ54 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[55]), .D(D_int_bmux[54]), .DFTRAMBYP(1'b0), .mem_path(mem_path[54]), .XQ(XQ|XD_int[54]), .Q(Q_int[54]));
  datapath_latch_sram1024x64 uDQ55 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[56]), .D(D_int_bmux[55]), .DFTRAMBYP(1'b0), .mem_path(mem_path[55]), .XQ(XQ|XD_int[55]), .Q(Q_int[55]));
  datapath_latch_sram1024x64 uDQ56 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[57]), .D(D_int_bmux[56]), .DFTRAMBYP(1'b0), .mem_path(mem_path[56]), .XQ(XQ|XD_int[56]), .Q(Q_int[56]));
  datapath_latch_sram1024x64 uDQ57 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[58]), .D(D_int_bmux[57]), .DFTRAMBYP(1'b0), .mem_path(mem_path[57]), .XQ(XQ|XD_int[57]), .Q(Q_int[57]));
  datapath_latch_sram1024x64 uDQ58 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[59]), .D(D_int_bmux[58]), .DFTRAMBYP(1'b0), .mem_path(mem_path[58]), .XQ(XQ|XD_int[58]), .Q(Q_int[58]));
  datapath_latch_sram1024x64 uDQ59 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[60]), .D(D_int_bmux[59]), .DFTRAMBYP(1'b0), .mem_path(mem_path[59]), .XQ(XQ|XD_int[59]), .Q(Q_int[59]));
  datapath_latch_sram1024x64 uDQ60 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[61]), .D(D_int_bmux[60]), .DFTRAMBYP(1'b0), .mem_path(mem_path[60]), .XQ(XQ|XD_int[60]), .Q(Q_int[60]));
  datapath_latch_sram1024x64 uDQ61 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[62]), .D(D_int_bmux[61]), .DFTRAMBYP(1'b0), .mem_path(mem_path[61]), .XQ(XQ|XD_int[61]), .Q(Q_int[61]));
  datapath_latch_sram1024x64 uDQ62 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[63]), .D(D_int_bmux[62]), .DFTRAMBYP(1'b0), .mem_path(mem_path[62]), .XQ(XQ|XD_int[62]), .Q(Q_int[62]));
  datapath_latch_sram1024x64 uDQ63 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(1'b0), .D(D_int_bmux[63]), .DFTRAMBYP(1'b0), .mem_path(mem_path[63]), .XQ(XQ|XD_int[63]|1'b0), .Q(Q_int[63]));
...
`endif
  ...
  reg NOT_CEN, NOT_GWEN, NOT_A9, NOT_A8, NOT_A7, NOT_A6, NOT_A5, NOT_A4, NOT_A3, NOT_A2;
  reg NOT_A1, NOT_A0, NOT_D63, NOT_D62, NOT_D61, NOT_D60, NOT_D59, NOT_D58, NOT_D57;
  reg NOT_D56, NOT_D55, NOT_D54, NOT_D53, NOT_D52, NOT_D51, NOT_D50, NOT_D49, NOT_D48;
  reg NOT_D47, NOT_D46, NOT_D45, NOT_D44, NOT_D43, NOT_D42, NOT_D41, NOT_D40, NOT_D39;
  reg NOT_D38, NOT_D37, NOT_D36, NOT_D35, NOT_D34, NOT_D33, NOT_D32, NOT_D31, NOT_D30;
  ...
  reg NOT_D1, NOT_D0, NOT_WEN63, NOT_WEN62, NOT_WEN61, NOT_WEN60, NOT_WEN59, NOT_WEN58;
  reg NOT_WEN57, NOT_WEN56, NOT_WEN55, NOT_WEN54, NOT_WEN53, NOT_WEN52, NOT_WEN51;
  reg NOT_WEN50, NOT_WEN49, NOT_WEN48, NOT_WEN47, NOT_WEN46, NOT_WEN45, NOT_WEN44;
  reg NOT_WEN43, NOT_WEN42, NOT_WEN41, NOT_WEN40, NOT_WEN39, NOT_WEN38, NOT_WEN37;
  reg NOT_WEN36, NOT_WEN35, NOT_WEN34, NOT_WEN33, NOT_WEN32, NOT_WEN31, NOT_WEN30;
  reg NOT_WEN29, NOT_WEN28, NOT_WEN27, NOT_WEN26, NOT_WEN25, NOT_WEN24, NOT_WEN23;
  reg NOT_WEN22, NOT_WEN21, NOT_WEN20, NOT_WEN19, NOT_WEN18, NOT_WEN17, NOT_WEN16;
  reg NOT_WEN15, NOT_WEN14, NOT_WEN13, NOT_WEN12, NOT_WEN11, NOT_WEN10, NOT_WEN9, NOT_WEN8;
  reg NOT_WEN7, NOT_WEN6, NOT_WEN5, NOT_WEN4, NOT_WEN3, NOT_WEN2, NOT_WEN1, NOT_WEN0;
  reg NOT_STOV, NOT_EMA2, NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_EMAS, NOT_RET1N;
  reg NOT_RAWL, NOT_RAWLM1, NOT_RAWLM0, NOT_WABL, NOT_WABLM2, NOT_WABLM1, NOT_WABLM0;
 ...
 wire [2:0] dWABLM;
  ...
  buf B98(D_[21],dD[21]);
  buf B99(D_[22],dD[22]);
  buf B100(D_[23],dD[23]);
  buf B101(D_[24],dD[24]);
  buf B102(D_[25],dD[25]);
  buf B103(D_[26],dD[26]);
  buf B104(D_[27],dD[27]);
  buf B105(D_[28],dD[28]);
  buf B106(D_[29],dD[29]);
  buf B107(D_[30],dD[30]);
  buf B108(D_[31],dD[31]);
  buf B109(D_[32],dD[32]);
  buf B110(D_[33],dD[33]);
  buf B111(D_[34],dD[34]);
  buf B112(D_[35],dD[35]);
  buf B113(D_[36],dD[36]);
  buf B114(D_[37],dD[37]);
  buf B115(D_[38],dD[38]);
  buf B116(D_[39],dD[39]);
  buf B117(D_[40],dD[40]);
  buf B118(D_[41],dD[41]);
  buf B119(D_[42],dD[42]);
  buf B120(D_[43],dD[43]);
  buf B121(D_[44],dD[44]);
  buf B122(D_[45],dD[45]);
  buf B123(D_[46],dD[46]);
  buf B124(D_[47],dD[47]);
  buf B125(D_[48],dD[48]);
  buf B126(D_[49],dD[49]);
  buf B127(D_[50],dD[50]);
  buf B128(D_[51],dD[51]);
  buf B129(D_[52],dD[52]);
  buf B130(D_[53],dD[53]);
  buf B131(D_[54],dD[54]);
  buf B132(D_[55],dD[55]);
  buf B133(D_[56],dD[56]);
  buf B134(D_[57],dD[57]);
  buf B135(D_[58],dD[58]);
  buf B136(D_[59],dD[59]);
  buf B137(D_[60],dD[60]);
  buf B138(D_[61],dD[61]);
  buf B139(D_[62],dD[62]);
  buf B140(D_[63],dD[63]);
  buf B141(WEN_[0],dWEN[0]);
  buf B142(WEN_[1],dWEN[1]);
  buf B143(WEN_[2],dWEN[2]);
  buf B144(WEN_[3],dWEN[3]);
  buf B145(WEN_[4],dWEN[4]);
  buf B146(WEN_[5],dWEN[5]);
  buf B147(WEN_[6],dWEN[6]);
  buf B148(WEN_[7],dWEN[7]);
  buf B149(WEN_[8],dWEN[8]);
  buf B150(WEN_[9],dWEN[9]);
  buf B151(WEN_[10],dWEN[10]);
  buf B152(WEN_[11],dWEN[11]);
  buf B153(WEN_[12],dWEN[12]);
  buf B154(WEN_[13],dWEN[13]);
  buf B155(WEN_[14],dWEN[14]);
  buf B156(WEN_[15],dWEN[15]);
  buf B157(WEN_[16],dWEN[16]);
  buf B158(WEN_[17],dWEN[17]);
  buf B159(WEN_[18],dWEN[18]);
  buf B160(WEN_[19],dWEN[19]);
  buf B161(WEN_[20],dWEN[20]);
  buf B162(WEN_[21],dWEN[21]);
  buf B163(WEN_[22],dWEN[22]);
  buf B164(WEN_[23],dWEN[23]);
  buf B165(WEN_[24],dWEN[24]);
  buf B166(WEN_[25],dWEN[25]);
  buf B167(WEN_[26],dWEN[26]);
  buf B168(WEN_[27],dWEN[27]);
  buf B169(WEN_[28],dWEN[28]);
  buf B170(WEN_[29],dWEN[29]);
  buf B171(WEN_[30],dWEN[30]);
  buf B172(WEN_[31],dWEN[31]);
  buf B173(WEN_[32],dWEN[32]);
  buf B174(WEN_[33],dWEN[33]);
  buf B175(WEN_[34],dWEN[34]);
  buf B176(WEN_[35],dWEN[35]);
  buf B177(WEN_[36],dWEN[36]);
  buf B178(WEN_[37],dWEN[37]);
  buf B179(WEN_[38],dWEN[38]);
  buf B180(WEN_[39],dWEN[39]);
  buf B181(WEN_[40],dWEN[40]);
  buf B182(WEN_[41],dWEN[41]);
  buf B183(WEN_[42],dWEN[42]);
  buf B184(WEN_[43],dWEN[43]);
  buf B185(WEN_[44],dWEN[44]);
  buf B186(WEN_[45],dWEN[45]);
  buf B187(WEN_[46],dWEN[46]);
  buf B188(WEN_[47],dWEN[47]);
  buf B189(WEN_[48],dWEN[48]);
  buf B190(WEN_[49],dWEN[49]);
  buf B191(WEN_[50],dWEN[50]);
  buf B192(WEN_[51],dWEN[51]);
  buf B193(WEN_[52],dWEN[52]);
  buf B194(WEN_[53],dWEN[53]);
  buf B195(WEN_[54],dWEN[54]);
  buf B196(WEN_[55],dWEN[55]);
  buf B197(WEN_[56],dWEN[56]);
  buf B198(WEN_[57],dWEN[57]);
  buf B199(WEN_[58],dWEN[58]);
  buf B200(WEN_[59],dWEN[59]);
  buf B201(WEN_[60],dWEN[60]);
  buf B202(WEN_[61],dWEN[61]);
  buf B203(WEN_[62],dWEN[62]);
  buf B204(WEN_[63],dWEN[63]);
  buf B205(STOV_, dSTOV);
  buf B206(EMA_[0],dEMA[0]);
  buf B207(EMA_[1],dEMA[1]);
  buf B208(EMA_[2],dEMA[2]);
  buf B209(EMAW_[0],dEMAW[0]);
  buf B210(EMAW_[1],dEMAW[1]);
  buf B211(EMAS_, dEMAS);
  buf B212(RET1N_, dRET1N);
  buf B213(RAWL_, dRAWL);
  buf B214(RAWLM_[0],dRAWLM[0]);
  buf B215(RAWLM_[1],dRAWLM[1]);
  buf B216(WABL_, dWABL);
  buf B217(WABLM_[0],dWABLM[0]);
  buf B218(WABLM_[1],dWABLM[1]);
  buf B219(WABLM_[2],dWABLM[2]);
...
`endif
  ...
  wire RET1Neq1aCENeq0aWEN63eq0aGWENeq0, RET1Neq1aCENeq0aWEN62eq0aGWENeq0, RET1Neq1aCENeq0aWEN61eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN60eq0aGWENeq0, RET1Neq1aCENeq0aWEN59eq0aGWENeq0, RET1Neq1aCENeq0aWEN58eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN57eq0aGWENeq0, RET1Neq1aCENeq0aWEN56eq0aGWENeq0, RET1Neq1aCENeq0aWEN55eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN54eq0aGWENeq0, RET1Neq1aCENeq0aWEN53eq0aGWENeq0, RET1Neq1aCENeq0aWEN52eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN51eq0aGWENeq0, RET1Neq1aCENeq0aWEN50eq0aGWENeq0, RET1Neq1aCENeq0aWEN49eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN48eq0aGWENeq0, RET1Neq1aCENeq0aWEN47eq0aGWENeq0, RET1Neq1aCENeq0aWEN46eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN45eq0aGWENeq0, RET1Neq1aCENeq0aWEN44eq0aGWENeq0, RET1Neq1aCENeq0aWEN43eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN42eq0aGWENeq0, RET1Neq1aCENeq0aWEN41eq0aGWENeq0, RET1Neq1aCENeq0aWEN40eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN39eq0aGWENeq0, RET1Neq1aCENeq0aWEN38eq0aGWENeq0, RET1Neq1aCENeq0aWEN37eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN36eq0aGWENeq0, RET1Neq1aCENeq0aWEN35eq0aGWENeq0, RET1Neq1aCENeq0aWEN34eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN33eq0aGWENeq0, RET1Neq1aCENeq0aWEN32eq0aGWENeq0, RET1Neq1aCENeq0aWEN31eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN30eq0aGWENeq0, RET1Neq1aCENeq0aWEN29eq0aGWENeq0, RET1Neq1aCENeq0aWEN28eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN27eq0aGWENeq0, RET1Neq1aCENeq0aWEN26eq0aGWENeq0, RET1Neq1aCENeq0aWEN25eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN24eq0aGWENeq0, RET1Neq1aCENeq0aWEN23eq0aGWENeq0, RET1Neq1aCENeq0aWEN22eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN21eq0aGWENeq0, RET1Neq1aCENeq0aWEN20eq0aGWENeq0, RET1Neq1aCENeq0aWEN19eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN18eq0aGWENeq0, RET1Neq1aCENeq0aWEN17eq0aGWENeq0, RET1Neq1aCENeq0aWEN16eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN15eq0aGWENeq0, RET1Neq1aCENeq0aWEN14eq0aGWENeq0, RET1Neq1aCENeq0aWEN13eq0aGWENeq0;
  wire RET1Neq1aCENeq0aWEN12eq0aGWENeq0, RET1Neq1aCENeq0aWEN11eq0aGWENeq0, RET1Neq1aCENeq0aWEN10eq0aGWENeq0;
  ...
  specify
   ...
   `endif
    ...
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN63eq0aGWENeq0, posedge D[63], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D63,,,dCLK,dD[63]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN62eq0aGWENeq0, posedge D[62], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D62,,,dCLK,dD[62]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN61eq0aGWENeq0, posedge D[61], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D61,,,dCLK,dD[61]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN60eq0aGWENeq0, posedge D[60], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D60,,,dCLK,dD[60]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN59eq0aGWENeq0, posedge D[59], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D59,,,dCLK,dD[59]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN58eq0aGWENeq0, posedge D[58], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D58,,,dCLK,dD[58]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN57eq0aGWENeq0, posedge D[57], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D57,,,dCLK,dD[57]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN56eq0aGWENeq0, posedge D[56], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D56,,,dCLK,dD[56]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN55eq0aGWENeq0, posedge D[55], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D55,,,dCLK,dD[55]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN54eq0aGWENeq0, posedge D[54], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D54,,,dCLK,dD[54]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN53eq0aGWENeq0, posedge D[53], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D53,,,dCLK,dD[53]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN52eq0aGWENeq0, posedge D[52], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D52,,,dCLK,dD[52]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN51eq0aGWENeq0, posedge D[51], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D51,,,dCLK,dD[51]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN50eq0aGWENeq0, posedge D[50], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D50,,,dCLK,dD[50]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN49eq0aGWENeq0, posedge D[49], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D49,,,dCLK,dD[49]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN48eq0aGWENeq0, posedge D[48], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D48,,,dCLK,dD[48]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN47eq0aGWENeq0, posedge D[47], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D47,,,dCLK,dD[47]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN46eq0aGWENeq0, posedge D[46], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D46,,,dCLK,dD[46]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN45eq0aGWENeq0, posedge D[45], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D45,,,dCLK,dD[45]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN44eq0aGWENeq0, posedge D[44], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D44,,,dCLK,dD[44]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN43eq0aGWENeq0, posedge D[43], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D43,,,dCLK,dD[43]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN42eq0aGWENeq0, posedge D[42], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D42,,,dCLK,dD[42]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN41eq0aGWENeq0, posedge D[41], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D41,,,dCLK,dD[41]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN40eq0aGWENeq0, posedge D[40], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D40,,,dCLK,dD[40]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN39eq0aGWENeq0, posedge D[39], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D39,,,dCLK,dD[39]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN38eq0aGWENeq0, posedge D[38], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D38,,,dCLK,dD[38]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN37eq0aGWENeq0, posedge D[37], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D37,,,dCLK,dD[37]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN36eq0aGWENeq0, posedge D[36], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D36,,,dCLK,dD[36]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN35eq0aGWENeq0, posedge D[35], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D35,,,dCLK,dD[35]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN34eq0aGWENeq0, posedge D[34], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D34,,,dCLK,dD[34]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN33eq0aGWENeq0, posedge D[33], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D33,,,dCLK,dD[33]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN32eq0aGWENeq0, posedge D[32], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D32,,,dCLK,dD[32]);
    ...
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN63eq0aGWENeq0, negedge D[63], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D63,,,dCLK,dD[63]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN62eq0aGWENeq0, negedge D[62], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D62,,,dCLK,dD[62]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN61eq0aGWENeq0, negedge D[61], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D61,,,dCLK,dD[61]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN60eq0aGWENeq0, negedge D[60], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D60,,,dCLK,dD[60]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN59eq0aGWENeq0, negedge D[59], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D59,,,dCLK,dD[59]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN58eq0aGWENeq0, negedge D[58], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D58,,,dCLK,dD[58]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN57eq0aGWENeq0, negedge D[57], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D57,,,dCLK,dD[57]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN56eq0aGWENeq0, negedge D[56], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D56,,,dCLK,dD[56]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN55eq0aGWENeq0, negedge D[55], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D55,,,dCLK,dD[55]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN54eq0aGWENeq0, negedge D[54], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D54,,,dCLK,dD[54]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN53eq0aGWENeq0, negedge D[53], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D53,,,dCLK,dD[53]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN52eq0aGWENeq0, negedge D[52], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D52,,,dCLK,dD[52]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN51eq0aGWENeq0, negedge D[51], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D51,,,dCLK,dD[51]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN50eq0aGWENeq0, negedge D[50], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D50,,,dCLK,dD[50]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN49eq0aGWENeq0, negedge D[49], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D49,,,dCLK,dD[49]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN48eq0aGWENeq0, negedge D[48], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D48,,,dCLK,dD[48]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN47eq0aGWENeq0, negedge D[47], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D47,,,dCLK,dD[47]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN46eq0aGWENeq0, negedge D[46], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D46,,,dCLK,dD[46]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN45eq0aGWENeq0, negedge D[45], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D45,,,dCLK,dD[45]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN44eq0aGWENeq0, negedge D[44], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D44,,,dCLK,dD[44]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN43eq0aGWENeq0, negedge D[43], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D43,,,dCLK,dD[43]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN42eq0aGWENeq0, negedge D[42], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D42,,,dCLK,dD[42]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN41eq0aGWENeq0, negedge D[41], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D41,,,dCLK,dD[41]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN40eq0aGWENeq0, negedge D[40], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D40,,,dCLK,dD[40]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN39eq0aGWENeq0, negedge D[39], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D39,,,dCLK,dD[39]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN38eq0aGWENeq0, negedge D[38], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D38,,,dCLK,dD[38]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN37eq0aGWENeq0, negedge D[37], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D37,,,dCLK,dD[37]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN36eq0aGWENeq0, negedge D[36], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D36,,,dCLK,dD[36]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN35eq0aGWENeq0, negedge D[35], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D35,,,dCLK,dD[35]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN34eq0aGWENeq0, negedge D[34], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D34,,,dCLK,dD[34]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN33eq0aGWENeq0, negedge D[33], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D33,,,dCLK,dD[33]);
    $setuphold(posedge CLK &&& RET1Neq1aCENeq0aWEN32eq0aGWENeq0, negedge D[32], `ARM_MEM_SETUP, `ARM_MEM_HOLD, NOT_D32,,,dCLK,dD[32]);
...
`endif
 ...
 wire  CLK_;
  ...
  buf B359(D_[62], D[62]);
  buf B360(D_[63], D[63]);
  buf B361(WEN_[0], WEN[0]);
  buf B362(WEN_[1], WEN[1]);
  buf B363(WEN_[2], WEN[2]);
  buf B364(WEN_[3], WEN[3]);
  buf B365(WEN_[4], WEN[4]);
  buf B366(WEN_[5], WEN[5]);
  buf B367(WEN_[6], WEN[6]);
  buf B368(WEN_[7], WEN[7]);
  buf B369(WEN_[8], WEN[8]);
  buf B370(WEN_[9], WEN[9]);
  buf B371(WEN_[10], WEN[10]);
  buf B372(WEN_[11], WEN[11]);
  buf B373(WEN_[12], WEN[12]);
  buf B374(WEN_[13], WEN[13]);
  buf B375(WEN_[14], WEN[14]);
  buf B376(WEN_[15], WEN[15]);
  buf B377(WEN_[16], WEN[16]);
  buf B378(WEN_[17], WEN[17]);
  buf B379(WEN_[18], WEN[18]);
  buf B380(WEN_[19], WEN[19]);
  buf B381(WEN_[20], WEN[20]);
  buf B382(WEN_[21], WEN[21]);
  buf B383(WEN_[22], WEN[22]);
  buf B384(WEN_[23], WEN[23]);
  buf B385(WEN_[24], WEN[24]);
  buf B386(WEN_[25], WEN[25]);
  buf B387(WEN_[26], WEN[26]);
  buf B388(WEN_[27], WEN[27]);
  buf B389(WEN_[28], WEN[28]);
  buf B390(WEN_[29], WEN[29]);
  buf B391(WEN_[30], WEN[30]);
  buf B392(WEN_[31], WEN[31]);
  buf B393(WEN_[32], WEN[32]);
  buf B394(WEN_[33], WEN[33]);
  buf B395(WEN_[34], WEN[34]);
  buf B396(WEN_[35], WEN[35]);
  buf B397(WEN_[36], WEN[36]);
  buf B398(WEN_[37], WEN[37]);
  buf B399(WEN_[38], WEN[38]);
  buf B400(WEN_[39], WEN[39]);
  buf B401(WEN_[40], WEN[40]);
  buf B402(WEN_[41], WEN[41]);
  buf B403(WEN_[42], WEN[42]);
  buf B404(WEN_[43], WEN[43]);
  buf B405(WEN_[44], WEN[44]);
  buf B406(WEN_[45], WEN[45]);
  buf B407(WEN_[46], WEN[46]);
  buf B408(WEN_[47], WEN[47]);
  buf B409(WEN_[48], WEN[48]);
  buf B410(WEN_[49], WEN[49]);
  buf B411(WEN_[50], WEN[50]);
  buf B412(WEN_[51], WEN[51]);
  buf B413(WEN_[52], WEN[52]);
  buf B414(WEN_[53], WEN[53]);
  buf B415(WEN_[54], WEN[54]);
  buf B416(WEN_[55], WEN[55]);
  buf B417(WEN_[56], WEN[56]);
  buf B418(WEN_[57], WEN[57]);
  buf B419(WEN_[58], WEN[58]);
  buf B420(WEN_[59], WEN[59]);
  buf B421(WEN_[60], WEN[60]);
  buf B422(WEN_[61], WEN[61]);
  buf B423(WEN_[62], WEN[62]);
  buf B424(WEN_[63], WEN[63]);
  buf B425(STOV_, STOV);
  buf B426(EMA_[0], EMA[0]);
  buf B427(EMA_[1], EMA[1]);
  buf B428(EMA_[2], EMA[2]);
  buf B429(EMAW_[0], EMAW[0]);
  buf B430(EMAW_[1], EMAW[1]);
  buf B431(EMAS_, EMAS);
  buf B432(RET1N_, RET1N);
  buf B433(RAWL_, RAWL);
  buf B434(RAWLM_[0], RAWLM[0]);
  buf B435(RAWLM_[1], RAWLM[1]);
  buf B436(WABL_, WABL);
  buf B437(WABLM_[0], WABLM[0]);
  buf B438(WABLM_[1], WABLM[1]);
  buf B439(WABLM_[2], WABLM[2]);
...
`ifdef ARM_FAULT_MODELING
`timescale 1ns/1ps
module sram1024x64_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [63:0] Q_out;
   input [63:0] Q_in;
   input CLK;
   input [9:0] A;
...
initial
begin
   `ifdef sram1024x64_pre_pend_path
      `define pre_pend_path `sram1024x64_pre_pend_path
   `else
      `ifdef DUT
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.u1.add_fault(10'd754,6'd6,2'd1,2'd0);
   `endif
end
   task add_fault;
