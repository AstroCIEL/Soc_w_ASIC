...
//       
//       Creation Date:  Thu Mar 12 15:16:14 2026
//       Version: 	r1p0
//
...
`define ARM_OFFSET_TIME 0
  ...
  `define SRAM_SP_HDE_SVT_MVT_ARM_REF_EMA_VALUE   7
  `define SRAM_SP_HDE_SVT_MVT_ARM_REF_EMAW_VALUE  3
  `define SRAM_SP_HDE_SVT_MVT_ARM_REF_EMAS_VALUE  1


module datapath_latch_sram_1024_64_lx (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_sram_1024_64_lx
...
`ifdef POWER_PINS
module sram_1024_64_lx (VDDCE, VDDPE, VSSE, q, clk, cen, gwen, a, d, stov, ema, emaw, 
    emas, ret1n);
`else
module sram_1024_64_lx (q, clk, cen, gwen, a, d, stov, ema, emaw, emas, ret1n);
`endif
...
`endif
   ...
   `ifdef ARM_FAULT_MODELING
     sram_1024_64_lx_error_injection u1(.CLK(clk_), .Q_out(q_out), .A(a_int), .CEN(cen_int), .GWEN(gwen_int), .WEN(gwen_int), .Q_in(q_int));
  `else
   assign q_out = q_int;
  `endif
...
`endif
  ...
  if(isBitX(ema_int)) begin
    ...
    end else if (^{cen_int, (stov_int && !cen_int)} === 1'bx) begin
      failedWrite(0);
        Xq = 1'b1; q_update = 1'b1;
...
`endif
  ...
  datapath_latch_sram_1024_64_lx uDQ0 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(1'b0), .D(d_int_bmux[0]), .DFTRAMBYP(1'b0), .mem_path(mem_path[0]), .XQ(Xq|Xd_int[0]|1'b0), .Q(q_int[0]));
  datapath_latch_sram_1024_64_lx uDQ1 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[0]), .D(d_int_bmux[1]), .DFTRAMBYP(1'b0), .mem_path(mem_path[1]), .XQ(Xq|Xd_int[1]), .Q(q_int[1]));
  datapath_latch_sram_1024_64_lx uDQ2 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[1]), .D(d_int_bmux[2]), .DFTRAMBYP(1'b0), .mem_path(mem_path[2]), .XQ(Xq|Xd_int[2]), .Q(q_int[2]));
  datapath_latch_sram_1024_64_lx uDQ3 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[2]), .D(d_int_bmux[3]), .DFTRAMBYP(1'b0), .mem_path(mem_path[3]), .XQ(Xq|Xd_int[3]), .Q(q_int[3]));
  datapath_latch_sram_1024_64_lx uDQ4 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[3]), .D(d_int_bmux[4]), .DFTRAMBYP(1'b0), .mem_path(mem_path[4]), .XQ(Xq|Xd_int[4]), .Q(q_int[4]));
  datapath_latch_sram_1024_64_lx uDQ5 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[4]), .D(d_int_bmux[5]), .DFTRAMBYP(1'b0), .mem_path(mem_path[5]), .XQ(Xq|Xd_int[5]), .Q(q_int[5]));
  datapath_latch_sram_1024_64_lx uDQ6 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[5]), .D(d_int_bmux[6]), .DFTRAMBYP(1'b0), .mem_path(mem_path[6]), .XQ(Xq|Xd_int[6]), .Q(q_int[6]));
  datapath_latch_sram_1024_64_lx uDQ7 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[6]), .D(d_int_bmux[7]), .DFTRAMBYP(1'b0), .mem_path(mem_path[7]), .XQ(Xq|Xd_int[7]), .Q(q_int[7]));
  datapath_latch_sram_1024_64_lx uDQ8 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[7]), .D(d_int_bmux[8]), .DFTRAMBYP(1'b0), .mem_path(mem_path[8]), .XQ(Xq|Xd_int[8]), .Q(q_int[8]));
  datapath_latch_sram_1024_64_lx uDQ9 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[8]), .D(d_int_bmux[9]), .DFTRAMBYP(1'b0), .mem_path(mem_path[9]), .XQ(Xq|Xd_int[9]), .Q(q_int[9]));
  datapath_latch_sram_1024_64_lx uDQ10 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[9]), .D(d_int_bmux[10]), .DFTRAMBYP(1'b0), .mem_path(mem_path[10]), .XQ(Xq|Xd_int[10]), .Q(q_int[10]));
  datapath_latch_sram_1024_64_lx uDQ11 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[10]), .D(d_int_bmux[11]), .DFTRAMBYP(1'b0), .mem_path(mem_path[11]), .XQ(Xq|Xd_int[11]), .Q(q_int[11]));
  datapath_latch_sram_1024_64_lx uDQ12 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[11]), .D(d_int_bmux[12]), .DFTRAMBYP(1'b0), .mem_path(mem_path[12]), .XQ(Xq|Xd_int[12]), .Q(q_int[12]));
  datapath_latch_sram_1024_64_lx uDQ13 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[12]), .D(d_int_bmux[13]), .DFTRAMBYP(1'b0), .mem_path(mem_path[13]), .XQ(Xq|Xd_int[13]), .Q(q_int[13]));
  datapath_latch_sram_1024_64_lx uDQ14 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[13]), .D(d_int_bmux[14]), .DFTRAMBYP(1'b0), .mem_path(mem_path[14]), .XQ(Xq|Xd_int[14]), .Q(q_int[14]));
  datapath_latch_sram_1024_64_lx uDQ15 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[14]), .D(d_int_bmux[15]), .DFTRAMBYP(1'b0), .mem_path(mem_path[15]), .XQ(Xq|Xd_int[15]), .Q(q_int[15]));
  datapath_latch_sram_1024_64_lx uDQ16 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[15]), .D(d_int_bmux[16]), .DFTRAMBYP(1'b0), .mem_path(mem_path[16]), .XQ(Xq|Xd_int[16]), .Q(q_int[16]));
  datapath_latch_sram_1024_64_lx uDQ17 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[16]), .D(d_int_bmux[17]), .DFTRAMBYP(1'b0), .mem_path(mem_path[17]), .XQ(Xq|Xd_int[17]), .Q(q_int[17]));
  datapath_latch_sram_1024_64_lx uDQ18 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[17]), .D(d_int_bmux[18]), .DFTRAMBYP(1'b0), .mem_path(mem_path[18]), .XQ(Xq|Xd_int[18]), .Q(q_int[18]));
  datapath_latch_sram_1024_64_lx uDQ19 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[18]), .D(d_int_bmux[19]), .DFTRAMBYP(1'b0), .mem_path(mem_path[19]), .XQ(Xq|Xd_int[19]), .Q(q_int[19]));
  datapath_latch_sram_1024_64_lx uDQ20 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[19]), .D(d_int_bmux[20]), .DFTRAMBYP(1'b0), .mem_path(mem_path[20]), .XQ(Xq|Xd_int[20]), .Q(q_int[20]));
  datapath_latch_sram_1024_64_lx uDQ21 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[20]), .D(d_int_bmux[21]), .DFTRAMBYP(1'b0), .mem_path(mem_path[21]), .XQ(Xq|Xd_int[21]), .Q(q_int[21]));
  datapath_latch_sram_1024_64_lx uDQ22 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[21]), .D(d_int_bmux[22]), .DFTRAMBYP(1'b0), .mem_path(mem_path[22]), .XQ(Xq|Xd_int[22]), .Q(q_int[22]));
  datapath_latch_sram_1024_64_lx uDQ23 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[22]), .D(d_int_bmux[23]), .DFTRAMBYP(1'b0), .mem_path(mem_path[23]), .XQ(Xq|Xd_int[23]), .Q(q_int[23]));
  datapath_latch_sram_1024_64_lx uDQ24 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[23]), .D(d_int_bmux[24]), .DFTRAMBYP(1'b0), .mem_path(mem_path[24]), .XQ(Xq|Xd_int[24]), .Q(q_int[24]));
  datapath_latch_sram_1024_64_lx uDQ25 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[24]), .D(d_int_bmux[25]), .DFTRAMBYP(1'b0), .mem_path(mem_path[25]), .XQ(Xq|Xd_int[25]), .Q(q_int[25]));
  datapath_latch_sram_1024_64_lx uDQ26 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[25]), .D(d_int_bmux[26]), .DFTRAMBYP(1'b0), .mem_path(mem_path[26]), .XQ(Xq|Xd_int[26]), .Q(q_int[26]));
  datapath_latch_sram_1024_64_lx uDQ27 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[26]), .D(d_int_bmux[27]), .DFTRAMBYP(1'b0), .mem_path(mem_path[27]), .XQ(Xq|Xd_int[27]), .Q(q_int[27]));
  datapath_latch_sram_1024_64_lx uDQ28 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[27]), .D(d_int_bmux[28]), .DFTRAMBYP(1'b0), .mem_path(mem_path[28]), .XQ(Xq|Xd_int[28]), .Q(q_int[28]));
  datapath_latch_sram_1024_64_lx uDQ29 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[28]), .D(d_int_bmux[29]), .DFTRAMBYP(1'b0), .mem_path(mem_path[29]), .XQ(Xq|Xd_int[29]), .Q(q_int[29]));
  datapath_latch_sram_1024_64_lx uDQ30 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[29]), .D(d_int_bmux[30]), .DFTRAMBYP(1'b0), .mem_path(mem_path[30]), .XQ(Xq|Xd_int[30]), .Q(q_int[30]));
  datapath_latch_sram_1024_64_lx uDQ31 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[30]), .D(d_int_bmux[31]), .DFTRAMBYP(1'b0), .mem_path(mem_path[31]), .XQ(Xq|Xd_int[31]), .Q(q_int[31]));
  datapath_latch_sram_1024_64_lx uDQ32 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[33]), .D(d_int_bmux[32]), .DFTRAMBYP(1'b0), .mem_path(mem_path[32]), .XQ(Xq|Xd_int[32]), .Q(q_int[32]));
  datapath_latch_sram_1024_64_lx uDQ33 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[34]), .D(d_int_bmux[33]), .DFTRAMBYP(1'b0), .mem_path(mem_path[33]), .XQ(Xq|Xd_int[33]), .Q(q_int[33]));
  datapath_latch_sram_1024_64_lx uDQ34 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[35]), .D(d_int_bmux[34]), .DFTRAMBYP(1'b0), .mem_path(mem_path[34]), .XQ(Xq|Xd_int[34]), .Q(q_int[34]));
  datapath_latch_sram_1024_64_lx uDQ35 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[36]), .D(d_int_bmux[35]), .DFTRAMBYP(1'b0), .mem_path(mem_path[35]), .XQ(Xq|Xd_int[35]), .Q(q_int[35]));
  datapath_latch_sram_1024_64_lx uDQ36 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[37]), .D(d_int_bmux[36]), .DFTRAMBYP(1'b0), .mem_path(mem_path[36]), .XQ(Xq|Xd_int[36]), .Q(q_int[36]));
  datapath_latch_sram_1024_64_lx uDQ37 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[38]), .D(d_int_bmux[37]), .DFTRAMBYP(1'b0), .mem_path(mem_path[37]), .XQ(Xq|Xd_int[37]), .Q(q_int[37]));
  datapath_latch_sram_1024_64_lx uDQ38 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[39]), .D(d_int_bmux[38]), .DFTRAMBYP(1'b0), .mem_path(mem_path[38]), .XQ(Xq|Xd_int[38]), .Q(q_int[38]));
  datapath_latch_sram_1024_64_lx uDQ39 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[40]), .D(d_int_bmux[39]), .DFTRAMBYP(1'b0), .mem_path(mem_path[39]), .XQ(Xq|Xd_int[39]), .Q(q_int[39]));
  datapath_latch_sram_1024_64_lx uDQ40 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[41]), .D(d_int_bmux[40]), .DFTRAMBYP(1'b0), .mem_path(mem_path[40]), .XQ(Xq|Xd_int[40]), .Q(q_int[40]));
  datapath_latch_sram_1024_64_lx uDQ41 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[42]), .D(d_int_bmux[41]), .DFTRAMBYP(1'b0), .mem_path(mem_path[41]), .XQ(Xq|Xd_int[41]), .Q(q_int[41]));
  datapath_latch_sram_1024_64_lx uDQ42 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[43]), .D(d_int_bmux[42]), .DFTRAMBYP(1'b0), .mem_path(mem_path[42]), .XQ(Xq|Xd_int[42]), .Q(q_int[42]));
  datapath_latch_sram_1024_64_lx uDQ43 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[44]), .D(d_int_bmux[43]), .DFTRAMBYP(1'b0), .mem_path(mem_path[43]), .XQ(Xq|Xd_int[43]), .Q(q_int[43]));
  datapath_latch_sram_1024_64_lx uDQ44 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[45]), .D(d_int_bmux[44]), .DFTRAMBYP(1'b0), .mem_path(mem_path[44]), .XQ(Xq|Xd_int[44]), .Q(q_int[44]));
  datapath_latch_sram_1024_64_lx uDQ45 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[46]), .D(d_int_bmux[45]), .DFTRAMBYP(1'b0), .mem_path(mem_path[45]), .XQ(Xq|Xd_int[45]), .Q(q_int[45]));
  datapath_latch_sram_1024_64_lx uDQ46 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[47]), .D(d_int_bmux[46]), .DFTRAMBYP(1'b0), .mem_path(mem_path[46]), .XQ(Xq|Xd_int[46]), .Q(q_int[46]));
  datapath_latch_sram_1024_64_lx uDQ47 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[48]), .D(d_int_bmux[47]), .DFTRAMBYP(1'b0), .mem_path(mem_path[47]), .XQ(Xq|Xd_int[47]), .Q(q_int[47]));
  datapath_latch_sram_1024_64_lx uDQ48 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[49]), .D(d_int_bmux[48]), .DFTRAMBYP(1'b0), .mem_path(mem_path[48]), .XQ(Xq|Xd_int[48]), .Q(q_int[48]));
  datapath_latch_sram_1024_64_lx uDQ49 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[50]), .D(d_int_bmux[49]), .DFTRAMBYP(1'b0), .mem_path(mem_path[49]), .XQ(Xq|Xd_int[49]), .Q(q_int[49]));
  datapath_latch_sram_1024_64_lx uDQ50 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[51]), .D(d_int_bmux[50]), .DFTRAMBYP(1'b0), .mem_path(mem_path[50]), .XQ(Xq|Xd_int[50]), .Q(q_int[50]));
  datapath_latch_sram_1024_64_lx uDQ51 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[52]), .D(d_int_bmux[51]), .DFTRAMBYP(1'b0), .mem_path(mem_path[51]), .XQ(Xq|Xd_int[51]), .Q(q_int[51]));
  datapath_latch_sram_1024_64_lx uDQ52 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[53]), .D(d_int_bmux[52]), .DFTRAMBYP(1'b0), .mem_path(mem_path[52]), .XQ(Xq|Xd_int[52]), .Q(q_int[52]));
  datapath_latch_sram_1024_64_lx uDQ53 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[54]), .D(d_int_bmux[53]), .DFTRAMBYP(1'b0), .mem_path(mem_path[53]), .XQ(Xq|Xd_int[53]), .Q(q_int[53]));
  datapath_latch_sram_1024_64_lx uDQ54 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[55]), .D(d_int_bmux[54]), .DFTRAMBYP(1'b0), .mem_path(mem_path[54]), .XQ(Xq|Xd_int[54]), .Q(q_int[54]));
  datapath_latch_sram_1024_64_lx uDQ55 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[56]), .D(d_int_bmux[55]), .DFTRAMBYP(1'b0), .mem_path(mem_path[55]), .XQ(Xq|Xd_int[55]), .Q(q_int[55]));
  datapath_latch_sram_1024_64_lx uDQ56 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[57]), .D(d_int_bmux[56]), .DFTRAMBYP(1'b0), .mem_path(mem_path[56]), .XQ(Xq|Xd_int[56]), .Q(q_int[56]));
  datapath_latch_sram_1024_64_lx uDQ57 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[58]), .D(d_int_bmux[57]), .DFTRAMBYP(1'b0), .mem_path(mem_path[57]), .XQ(Xq|Xd_int[57]), .Q(q_int[57]));
  datapath_latch_sram_1024_64_lx uDQ58 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[59]), .D(d_int_bmux[58]), .DFTRAMBYP(1'b0), .mem_path(mem_path[58]), .XQ(Xq|Xd_int[58]), .Q(q_int[58]));
  datapath_latch_sram_1024_64_lx uDQ59 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[60]), .D(d_int_bmux[59]), .DFTRAMBYP(1'b0), .mem_path(mem_path[59]), .XQ(Xq|Xd_int[59]), .Q(q_int[59]));
  datapath_latch_sram_1024_64_lx uDQ60 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[61]), .D(d_int_bmux[60]), .DFTRAMBYP(1'b0), .mem_path(mem_path[60]), .XQ(Xq|Xd_int[60]), .Q(q_int[60]));
  datapath_latch_sram_1024_64_lx uDQ61 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[62]), .D(d_int_bmux[61]), .DFTRAMBYP(1'b0), .mem_path(mem_path[61]), .XQ(Xq|Xd_int[61]), .Q(q_int[61]));
  datapath_latch_sram_1024_64_lx uDQ62 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(q_int[63]), .D(d_int_bmux[62]), .DFTRAMBYP(1'b0), .mem_path(mem_path[62]), .XQ(Xq|Xd_int[62]), .Q(q_int[62]));
  datapath_latch_sram_1024_64_lx uDQ63 (.CLK(clk), .Q_update(q_update), .D_update(d_sh_update), .SE(1'b0), .SI(1'b0), .D(d_int_bmux[63]), .DFTRAMBYP(1'b0), .mem_path(mem_path[63]), .XQ(Xq|Xd_int[63]|1'b0), .Q(q_int[63]));
...
`endif
  ...
  reg NOT_d1, NOT_d0, NOT_stov, NOT_ema2, NOT_ema1, NOT_ema0, NOT_emaw1, NOT_emaw0;
 ...
 wire  dret1n;
  ...
  buf B141(stov_, dstov);
  buf B142(ema_[0],dema[0]);
  buf B143(ema_[1],dema[1]);
  buf B144(ema_[2],dema[2]);
  buf B145(emaw_[0],demaw[0]);
  buf B146(emaw_[1],demaw[1]);
  buf B147(emas_, demas);
  buf B148(ret1n_, dret1n);
...
`endif
  ...
  always @ globalNotifier0 begin
    if ($realtime == 0) begin
    end else if (cen_int === 1'bx || clk0_int === 1'bx || ret1n_int === 1'bx || (stov_int && !cen_int) === 1'bx) begin
        Xq = 1'b1; q_update = 1'b1;
    	 mem_path = {64{1'bx}};
      q_int_delayed = {64{1'bx}};
      failedWrite(0);
...
`endif
  ...
  wire stoveq0aret1neq1aceneq0, stoveq1aret1neq1aceneq0, ret1neq1, ret1neq1aceneq0agweneq0;
...
`endif
 ...
 wire  clk_;
  ...
  buf B289(d_[63], d[63]);
  buf B290(stov_, stov);
  buf B291(ema_[0], ema[0]);
  buf B292(ema_[1], ema[1]);
  buf B293(ema_[2], ema[2]);
  buf B294(emaw_[0], emaw[0]);
  buf B295(emaw_[1], emaw[1]);
  buf B296(emas_, emas);
  buf B297(ret1n_, ret1n);
...
`ifdef ARM_FAULT_MODELING
`timescale 1ns/1ps
module sram_1024_64_lx_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [63:0] Q_out;
   input [63:0] Q_in;
   input CLK;
   input [9:0] A;
...
initial
begin
   `ifdef sram_1024_64_lx_pre_pend_path
      `define pre_pend_path `sram_1024_64_lx_pre_pend_path
   `else
      `ifdef DUT
