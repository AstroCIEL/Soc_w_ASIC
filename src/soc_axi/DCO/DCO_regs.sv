//------------------------------------------------------------------------------
// Description: forward and backward pruning module
	...
	if (req_i.valid) begin
		if (req_i.write) begin
			...
			unique case (req_i.addr[12-1:0])
				...
				12'h004: rsp_o.rdata = {32'b0, 26'b0, fc_sel_q};
				12'h008: rsp_o.rdata = {32'b0, 29'b0, div_sel_q};
				12'h00c: rsp_o.rdata = {32'b0, 30'b0, freq_sel_q};
				default: rsp_o.error = 1'b1;
			endcase
		end
	end
