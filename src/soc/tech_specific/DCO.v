...
wire [3:0] int1;
`ifdef SVT
BUFFD1BWP6T16P96CPD  buf1(.Z(int1[0]), .I(A));
BUFFD4BWP6T16P96CPD buf2(.Z(int1[1]), .I(int1[0]));
BUFFD8BWP6T16P96CPD buf3(.Z(int1[2]), .I(int1[1]));
BUFFD12BWP6T16P96CPD buf4(.Z(int1[3]), .I(int1[2]));
BUFFD20BWP6T16P96CPD buf5(.Z(Y), .I(int1[3]));
`elsif LVT
BUFFD1BWP6T16P96CPDLVT  buf1(.Z(int1[0]), .I(A));
BUFFD4BWP6T16P96CPDLVT buf2(.Z(int1[1]), .I(int1[0]));
BUFFD8BWP6T16P96CPDLVT buf3(.Z(int1[2]), .I(int1[1]));
BUFFD12BWP6T16P96CPDLVT buf4(.Z(int1[3]), .I(int1[2]));
BUFFD20BWP6T16P96CPDLVT buf5(.Z(Y), .I(int1[3]));
`elsif ULVT
BUFFD1BWP6T16P96CPDULVT  buf1(.Z(int1[0]), .I(A));
BUFFD4BWP6T16P96CPDULVT buf2(.Z(int1[1]), .I(int1[0]));
BUFFD8BWP6T16P96CPDULVT buf3(.Z(int1[2]), .I(int1[1]));
BUFFD12BWP6T16P96CPDULVT buf4(.Z(int1[3]), .I(int1[2]));
BUFFD20BWP6T16P96CPDULVT buf5(.Z(Y), .I(int1[3]));
`endif
endmodule
...
wire A;
`ifdef SVT
INVD1BWP6T16P96CPD inv1(.ZN(Y), .I(A));
`elsif LVT
INVD1BWP6T16P96CPDLVT inv1(.ZN(Y), .I(A));
`elsif ULVT
INVD1BWP6T16P96CPDULVT inv1(.ZN(Y), .I(A));
`endif
endmodule
...
wire tmp;
`ifdef SVT
INVD1BWP6T16P96CPD buf1(.ZN(tmp), .I(A));
INVD2BWP6T16P96CPD buf2(.ZN(Y), .I(tmp));
`elsif LVT
INVD1BWP6T16P96CPDLVT buf1(.ZN(tmp), .I(A));
INVD2BWP6T16P96CPDLVT buf2(.ZN(Y), .I(tmp));
`elsif ULVT
INVD1BWP6T16P96CPDULVT buf1(.ZN(tmp), .I(A));
INVD2BWP6T16P96CPDULVT buf2(.ZN(Y), .I(tmp));
`endif
endmodule
...
`ifdef SVT
BUFFD16BWP6T16P96CPD buf1(.Z(Y), .I(A));
`elsif LVT
BUFFD16BWP6T16P96CPDLVT buf1(.Z(Y), .I(A));
`elsif ULVT
BUFFD16BWP6T16P96CPDULVT buf1(.Z(Y), .I(A));
`endif
endmodule
...
`ifdef SVT
MUX2D4BWP6T16P96CPD mux2(.Z(Y), .S(SEL), .I0(A), .I1(B));
`elsif LVT
MUX2D4BWP6T16P96CPDLVT mux2(.Z(Y), .S(SEL), .I0(A), .I1(B));
`elsif ULVT
MUX2D4BWP6T16P96CPDULVT mux2(.Z(Y), .S(SEL), .I0(A), .I1(B));
`endif
endmodule
...
wire EN, A;
`ifdef SVT
ND2D4BWP6T16P96CPD nand2_cell (.A2(EN), .A1(A), .ZN());
`elsif LVT
ND2D4BWP6T16P96CPDLVT nand2_cell (.A2(EN), .A1(A), .ZN());
`elsif ULVT
ND2D4BWP6T16P96CPDULVT nand2_cell (.A2(EN), .A1(A), .ZN());
`endif
endmodule
...
`ifdef SVT
ND2D2BWP6T16P96CPD nanden(.ZN(A_tmp[0]), .A1(A[6]), .A2(EN));
`elsif LVT
ND2D2BWP6T16P96CPDLVT nanden(.ZN(A_tmp[0]), .A1(A[6]), .A2(EN));
`elsif ULVT
ND2D2BWP6T16P96CPDULVT nanden(.ZN(A_tmp[0]), .A1(A[6]), .A2(EN));
`endif
...
`ifdef SVT
DFKCNQD2BWP6T16P96CPD DFFSQN(.CP(CLK_IN), .D(CLK_DIV_D), .Q(CLK_DIV_Q), .CN(FRSTN));
INVD1BWP6T16P96CPD inv1(.ZN(CLK_DIV_QN), .I(CLK_DIV_Q));
`ifdef LVT
DFKCNQD2BWP6T16P96CPDLVT DFFSQN(.CP(CLK_IN), .D(CLK_DIV_D), .Q(CLK_DIV_Q), .CN(FRSTN));
INVD1BWP6T16P96CPDLVT inv1(.ZN(CLK_DIV_QN), .I(CLK_DIV_Q));
`elsif ULVT
DFKCNQD2BWP6T16P96CPDULVT DFFSQN(.CP(CLK_IN), .D(CLK_DIV_D), .Q(CLK_DIV_Q), .CN(FRSTN));
INVD1BWP6T16P96CPDULVT inv1(.ZN(CLK_DIV_QN), .I(CLK_DIV_Q));
`endif
