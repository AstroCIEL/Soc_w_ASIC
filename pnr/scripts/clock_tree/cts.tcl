...
optDesign -postCTS -hold -holdVioData  ../${rm_core_top}/reports/postCTS/holdVio
...
timeDesign   -outDir ../${rm_core_top}/reports/postCTS \
             -expandedViews \
             -postCTS
report_power -o ../${rm_core_top}/reports/postCTS \
