...
//
// Testbench for minimum_dco SoC — system clock from on-chip DCO.
// cd sim
...
module ariane_soc_minimum_dco_tb;
  ...
  assign sys_clk   = dut.i_dco_wrapper.clk_o;
  ...
  ariane_soc_top dut (
    .dco_ext_clk_i    ( dco_ext_clk    ),
    .dco_en_i         ( dco_en         ),
    .dco_cc_sel_i     ( dco_cc_sel     ),
    .dco_fc_sel_i     ( dco_fc_sel     ),
    .dco_clk_sel_i    ( dco_clk_sel    ),
    .dco_freq_sel_i   ( dco_freq_sel   ),
    .dco_clk_div_o    ( dco_clk_div    ),
    .rtc_i            ( rtc            ),
    .rst_ni           ( rst_n          ),
    .uart_rx_i        ( uart_rx        ),
    .uart_tx_o        ( uart_tx        ),
...
endmodule : ariane_soc_minimum_dco_tb
