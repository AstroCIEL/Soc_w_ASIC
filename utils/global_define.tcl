...
foreach cell $cell_ext {
  set rm_fill_cells [concat FILL2${cell}   FILL3${cell}  DCAP4${cell} DCAP8${cell} \
                            DCAP16${cell}  DCAP32${cell} DCAP64${cell} ] \
}
...
set rm_tap_cell_distance   14	;# maximum distance of 120um for shared adjacent rows 60 maximum distance for top and bottom rows
...
## List of physical only cells to be excluded from the LVS netlist. This list would typically include tap, filler and boundary cells
set lvs_exclude_cells [concat ${rm_tap_cell} ${rm_fill_cells} ${endcap_left} ${endcap_right} PCORNER PFILLER20 PFILLER10 PFILLER5 PFILLER1 PFILLER05 PFILLER0005]
...
set rm_load_value                       1.5                 ;# Capacitive load in pF placed on all outputs [0.04]
...
set tt_0p80v_25c_libs  ${base_lib_dir}/${base_tt_0p80v_25c_lib}.lib

# TT(Typical-Typical) 0p80V 85C Libs
set tt_0p80v_85c_libs  ${base_lib_dir}/${base_tt_0p80v_85c_lib}.lib

# FF(Fast-Fast) 0p88V 125C Libs
set ff_0p88v_125c_libs ${base_lib_dir}/${base_ff_0p88v_125c_lib}.lib

# FF(Fast-Fast) 0p88V 0C Libs
set ff_0p88v_0c_libs   ${base_lib_dir}/${base_ff_0p88v_0c_lib}.lib

# FF(Fast-Fast) 0p88V m40C Libs
set ff_0p88v_m40c_libs ${base_lib_dir}/${base_ff_0p88v_m40c_lib}.lib

# SS(Slow-Slow) 0p72V 125C Libs
set ss_0p72v_125c_libs ${base_lib_dir}/${base_ss_0p72v_125c_lib}.lib

# SS(Slow-Slow) 0p72V 0C Libs
set ss_0p72v_0c_libs   ${base_lib_dir}/${base_ss_0p72v_0c_lib}.lib

# SS(Slow-Slow) 0p72V m40C Libs
set ss_0p72v_m40c_libs ${base_lib_dir}/${base_ss_0p72v_m40c_lib}.lib
...
set proj(constraints,func) ../../utils/constraints_${rm_core_top}.sdc
