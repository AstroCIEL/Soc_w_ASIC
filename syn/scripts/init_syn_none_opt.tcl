#####################################################################################
# Description:  Genus Logic Synthesis Configuration with No Optimization
...
set_db iopt_lp_power_analysis_effort low
...
set_db [vfind . -design *] .lp_clock_gating_auto_cost_grouping false
...
set_db [vfind . -design *] .lp_clock_gating_auto_path_adjust none
...
# default: false
set_db [vfind . -design *] .retime false
