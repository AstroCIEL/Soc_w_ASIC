...
DCIM_GENCFG_TXT := TYPE=$(DCIM_TYPE) ACC=$(DCIM_ACC) WD1=$(DCIM_WD1) CH_IN=$(DCIM_CH_IN) CH_OUT=$(DCIM_CH_OUT) R=$(DCIM_R) ACT_ROWS=$(DCIM_ACT_ROWS) WEI_ROWS=$(DCIM_WEI_ROWS) SEED=$(DCIM_SEED) TOPO=$(DCIM_TEST_TOPO)
